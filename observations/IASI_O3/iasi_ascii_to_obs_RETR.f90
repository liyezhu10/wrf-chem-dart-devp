...
real(digits12), allocatable, dimension(:,:) :: Z
real(digits12), allocatable, dimension(:,:) :: U,U_T,V,V_T,SV_m
real(digits12), allocatable, dimension(:)   :: SV,ZC
