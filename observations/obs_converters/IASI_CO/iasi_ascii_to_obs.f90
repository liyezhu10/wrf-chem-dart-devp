...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/tags/wrf-chem.r13172/observations/IASI_CO/iasi_ascii_to_obs.f90 $
...
character(len=128), parameter :: &
   source   = "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/tags/wrf-chem.r13172/observations/IASI_CO/iasi_ascii_to_obs.f90 $", &
