...
character(len=*), parameter :: source   = 'iasi_co_ascii_to_obs.f90'
...
end program iasi_co_ascii_to_obs
!
...
!
! This subroutine is attache to iasi_co_ascii_to_obs.f90 to identify to vertical
