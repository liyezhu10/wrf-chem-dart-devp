...
! version controlled file description for error handling, do not edit
   character(len=*), parameter :: source   = 'iasi_o3_ascii_to_obs.f90'
...
end program iasi_o3_ascii_to_obs
!
...
!
! This subroutine is attached to iasi_o3_ascii_to_obs.f90 to identify to vertical
