...
!
   program create_airnow_pm10_obs_sequence
!
! <next few lines under version control, do not edit>
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/mizzi/observations/AIRNOW/airnow_pm10_ascii_to_obs.f90 $
! $Id: airnow_pm10_ascii_to_obs.f90 13165 2019-05-07 17:11:04Z thoar@ucar.edu $
! $Revision: 13165 $
...
! version controlled file description for error handling, do not edit                          
      ...
      source   = "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/mizzi/observations/AIRNOW/airnow_pm10_ascii_to_obs.f90 $", &
...
!
      ...
      real                         :: pm10_log_max, pm10_log_min
...
!-----------------------------------------------------------------------------
   ...
   end program create_airnow_pm10_obs_sequence
!
