...
!   case(AIRNOW_PM25)
!        call get_expected_airnow_pm25(state_handle, ens_size, location, expected_obs, istatus) 
...
!
subroutine get_expected_airnow_pm25(state_handle, ens_size, location, val, istatus)  
!------------------------------------------------------------------------
