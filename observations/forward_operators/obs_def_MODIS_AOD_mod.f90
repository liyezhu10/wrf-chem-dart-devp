...
!            call get_expected_modis_aod(state_handle, ens_size, location, obs_def%key, expected_obs, istatus)  
...
character(len=*), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/tags/wrf-chem.r13172/obs_def/obs_def_MODIS_AOD_mod.f90 $"
...
subroutine get_expected_modis_aod(state_handle, ens_size, location, key, val, istatus)
...
real(r8)            :: mloc(3)
real(r8)    :: obs_val(ens_size)
logical :: return_now
integer  :: modis_istatus(ens_size)
...
call interpolate(state_handle, ens_size, loc2, QTY_AOD, obs_val, modis_istatus)  
call track_status(ens_size, modis_istatus, obs_val, istatus, return_now)
val = obs_val  
