...
!
! DART $Id: obs_def_OMI_NO2_mod.f90 11956 2017-09-26 19:47:16Z thoar@ucar.edu $
...
use    obs_kind_mod, only  : QTY_NO2, QTY_SURFACE_PRESSURE
...
character(len=*), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/tags/wrf-chem.r13172/obs_def/obs_def_OMI_NO2_mod.f90 $"
...
subroutine get_expected_omi_no2(state_handle, ens_size, location, key, val, istatus)
...
! Get wrf surface pressure
   ...
   call interpolate(state_handle, ens_size, loc2, QTY_SURFACE_PRESSURE, wrf_psf, this_istatus)  
   call track_status(ens_size, this_istatus, wrf_psf, istatus, return_now)
...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/tags/wrf-chem.r13172/obs_def/obs_def_OMI_NO2_mod.f90 $
! $Id: obs_def_OMI_NO2_mod.f90 11956 2017-09-26 19:47:16Z thoar@ucar.edu $
! $Revision: 11956 $
