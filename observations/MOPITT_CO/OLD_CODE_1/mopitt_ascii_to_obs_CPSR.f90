...
double precision, allocatable, dimension(:)   :: s_x_r, s_x_p, s_x_qr 
double precision, allocatable, dimension(:,:) :: s_avg_k, s_cov_r
double precision, allocatable, dimension(:)   :: rs_x_r, rs_x_p, rs_x_qr
double precision, allocatable, dimension(:)   :: err2_rs_r, err2_rs_a
double precision, allocatable, dimension(:)   :: adj_x_p, adj_x_r
!
double precision, allocatable, dimension(:,:) :: Z, ZT, U_avk, V_avk, U_cvr, V_cvr
double precision, allocatable, dimension(:,:) :: UT_avk, VT_avk, UT_cvr, VT_cvr
double precision, allocatable, dimension(:,:) :: SV
double precision, allocatable, dimension(:)   :: SV_avk, SV_cvr, SV_sav
double precision, allocatable, dimension(:,:) :: adj_avg_k, s_cvr, rs_avg_k, rs_cov_r
integer   :: apm_count   
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
...
! APM: clean up allocatables from my code
             deallocate(rs_x_r,rs_x_p,rs_x_qr,rs_avg_k,rs_cov_r)
       !
       !--------------------------------------------------------
...
!
             ...
             deallocate(rs_cov_r,rs_avg_k,rs_x_r,rs_x_p,rs_x_qr)
             deallocate(err2_rs_r)
          endif    ! qstatus
       endif    ! co_qc(1)
