...
character(len=*), parameter :: source   = 'mopitt_ascii_to_obs_SUPR_OBS_OLD.f90'
...
! dlat_qc=360./nlon_qc
!
! 30 km (insufficient memory)
!integer,parameter      :: nlon_qc=1333, nlat_qc=1036, nqc_obs=40 
!real*8,parameter       :: dlon_qc=.27, dlat_qc=.17
! 40 km (insufficient memory)
!integer,parameter      :: nlon_qc=1000, nlat_qc=777, nqc_obs=40 
!real*8,parameter       :: dlon_qc=.36, dlat_qc=.23
! 44 km
