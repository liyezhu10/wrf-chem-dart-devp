...
if ( version eq 'v3' ) then begin
     ...
     ; note that covariance is reported but averaging kernel is to be calculated
endif else begin
     ; note that mopittlev [0] is psurf (hPa)
...
for k = 0L, nx do begin 
  ...
  'v3' : begin
        ...
        ;==============================================
          ...
          ; fill in the other half of the symmetric matrix
          for j=0,5 do begin
              for ik=1,6 do begin
...
; 
        ...
        case output_rows_leading of
            ...
            ; output only the first leading component
            1: begin
               valid_nrows = 1
               output_start_row = 0
               output_end_row   = 0
