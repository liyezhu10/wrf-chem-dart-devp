...
#ifdef HAVE_MPI
  subroutine brian_test(dummy)
    integer(SHR_KIND_IN), intent(in) :: dummy
  end subroutine brian_test
#else
  subroutine brian_test_nofunc(dummy)
    integer(SHR_KIND_IN), intent(in) :: dummy
  end subroutine brian_test_nofunc
#endif
...
!
   ...
   integer, optional,  intent(IN) :: maxthreads      ! Number of threads 
!
!---------------------------Local workspace-----------------------------
!
...
!---------------------------Namelists ----------------------------------
!
   integer horz_num_threads
   integer tracer_num_threads
   integer vert_num_threads
   namelist /thr_nl/ horz_num_threads, tracer_num_threads, vert_num_threads
