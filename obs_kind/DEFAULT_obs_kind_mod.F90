...
! kinds for estimating obs valeus - error/bias/etc
! for josh and raquel and others
integer, parameter, public :: &
  KIND_OBS_ERR_TEMPERATURE        = 311, &
  KIND_OBS_ERR_SURF_PRESSURE      = 312, &
  KIND_OBS_ERR_PRESSURE           = 313, &
  KIND_OBS_ERR_U_COMP_WIND        = 314, &
  KIND_OBS_ERR_V_COMP_WIND        = 315, &
  KIND_OBS_ERR_WIND_DIR           = 316, &
  KIND_OBS_ERR_WIND_SPEED         = 317, &
  KIND_OBS_ERR_SPEC_HUMIDITY      = 318

!! PRIVATE ONLY TO THIS MODULE. see comment below near the max_obs_specific
!! declaration.

integer, parameter :: max_obs_generic = 318
