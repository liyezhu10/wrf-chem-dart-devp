...
! test for coupled component assimilation
! distinguish between air and water temp observations
integer, parameter, public :: &
    KIND_AIR_TEMPERATURE             = 145, &
    KIND_WATER_TEMPERATURE           = 146
...
integer, parameter :: max_obs_generic = 310
...
type obs_type_type
   ...
   logical              :: assimilate
   logical              :: evaluate
   ! nsc new - which component number handles the forward operator
   ! for this obs type.
   integer              :: FO_component
...
type obs_kind_type
   integer                           :: index
   character(len = paramname_length) :: name
   ! nsc new - which component stores this in their state vector
   integer                           :: component
...
do i = 0, max_obs_generic
   obs_kind_names(i) = obs_kind_type(i, 'UNKNOWN', 0)
enddo

obs_kind_names( 0) = obs_kind_type(KIND_RAW_STATE_VARIABLE, 'KIND_RAW_STATE_VARIABLE', 0)
obs_kind_names( 1) = obs_kind_type(KIND_U_WIND_COMPONENT, 'KIND_U_WIND_COMPONENT', 0)
obs_kind_names( 2) = obs_kind_type(KIND_V_WIND_COMPONENT, 'KIND_V_WIND_COMPONENT', 0)
obs_kind_names( 3) = obs_kind_type(KIND_SURFACE_PRESSURE, 'KIND_SURFACE_PRESSURE', 0)
obs_kind_names( 4) = obs_kind_type(KIND_TEMPERATURE, 'KIND_TEMPERATURE', 0)
obs_kind_names( 5) = obs_kind_type(KIND_SPECIFIC_HUMIDITY, 'KIND_SPECIFIC_HUMIDITY', 0)
obs_kind_names( 6) = obs_kind_type(KIND_PRESSURE, 'KIND_PRESSURE', 0)
obs_kind_names( 7) = obs_kind_type(KIND_VERTICAL_VELOCITY, 'KIND_VERTICAL_VELOCITY', 0)
obs_kind_names( 8) = obs_kind_type(KIND_RAINWATER_MIXING_RATIO, 'KIND_RAINWATER_MIXING_RATIO', 0)
obs_kind_names( 9) = obs_kind_type(KIND_DEWPOINT, 'KIND_DEWPOINT', 0)
obs_kind_names(10) = obs_kind_type(KIND_DENSITY, 'KIND_DENSITY', 0)
obs_kind_names(11) = obs_kind_type(KIND_VELOCITY, 'KIND_VELOCITY', 0)
obs_kind_names(12) = obs_kind_type(KIND_RADAR_REFLECTIVITY, 'KIND_RADAR_REFLECTIVITY', 0)
obs_kind_names(13) = obs_kind_type(KIND_1D_INTEGRAL, 'KIND_1D_INTEGRAL', 0)
obs_kind_names(14) = obs_kind_type(KIND_GRAUPEL_MIXING_RATIO, 'KIND_GRAUPEL_MIXING_RATIO', 0)
obs_kind_names(15) = obs_kind_type(KIND_SNOW_MIXING_RATIO, 'KIND_SNOW_MIXING_RATIO', 0)
obs_kind_names(16) = obs_kind_type(KIND_GPSRO, 'KIND_GPSRO', 0)
obs_kind_names(17) = obs_kind_type(KIND_CLOUD_LIQUID_WATER, 'KIND_CLOUD_LIQUID_WATER', 0)
obs_kind_names(18) = obs_kind_type(KIND_CLOUD_ICE, 'KIND_CLOUD_ICE', 0)
obs_kind_names(19) = obs_kind_type(KIND_CONDENSATIONAL_HEATING, 'KIND_CONDENSATIONAL_HEATING', 0)
obs_kind_names(20) = obs_kind_type(KIND_VAPOR_MIXING_RATIO, 'KIND_VAPOR_MIXING_RATIO', 0)
obs_kind_names(21) = obs_kind_type(KIND_ICE_NUMBER_CONCENTRATION, 'KIND_ICE_NUMBER_CONCENTRATION', 0)
obs_kind_names(22) = obs_kind_type(KIND_GEOPOTENTIAL_HEIGHT, 'KIND_GEOPOTENTIAL_HEIGHT', 0)
obs_kind_names(23) = obs_kind_type(KIND_POTENTIAL_TEMPERATURE, 'KIND_POTENTIAL_TEMPERATURE', 0)
obs_kind_names(24) = obs_kind_type(KIND_SOIL_MOISTURE, 'KIND_SOIL_MOISTURE', 0)
obs_kind_names(25) = obs_kind_type(KIND_SURFACE_ELEVATION, 'KIND_SURFACE_ELEVATION', 0)
obs_kind_names(26) = obs_kind_type(KIND_GRAV_WAVE_DRAG_EFFIC, 'KIND_GRAV_WAVE_DRAG_EFFIC', 0)
obs_kind_names(27) = obs_kind_type(KIND_GRAV_WAVE_STRESS_FRACTION, 'KIND_GRAV_WAVE_STRESS_FRACTION', 0)
obs_kind_names(28) = obs_kind_type(KIND_TRACER_SOURCE, 'KIND_TRACER_SOURCE', 0)
obs_kind_names(29) = obs_kind_type(KIND_TRACER_CONCENTRATION, 'KIND_TRACER_CONCENTRATION', 0)
obs_kind_names(30) = obs_kind_type(KIND_MEAN_SOURCE, 'KIND_MEAN_SOURCE', 0)
obs_kind_names(31) = obs_kind_type(KIND_SOURCE_PHASE, 'KIND_SOURCE_PHASE', 0)
obs_kind_names(32) = obs_kind_type(KIND_POWER_WEIGHTED_FALL_SPEED, 'KIND_POWER_WEIGHTED_FALL_SPEED', 0)
obs_kind_names(33) = obs_kind_type(KIND_CLOUDWATER_MIXING_RATIO, 'KIND_CLOUDWATER_MIXING_RATIO', 0)
obs_kind_names(34) = obs_kind_type(KIND_ICE_MIXING_RATIO, 'KIND_ICE_MIXING_RATIO', 0)
obs_kind_names(35) = obs_kind_type(KIND_DROPLET_NUMBER_CONCENTR, 'KIND_DROPLET_NUMBER_CONCENTR', 0)
obs_kind_names(36) = obs_kind_type(KIND_SNOW_NUMBER_CONCENTR, 'KIND_SNOW_NUMBER_CONCENTR', 0)
obs_kind_names(37) = obs_kind_type(KIND_RAIN_NUMBER_CONCENTR, 'KIND_RAIN_NUMBER_CONCENTR', 0)
obs_kind_names(38) = obs_kind_type(KIND_GRAUPEL_NUMBER_CONCENTR, 'KIND_GRAUPEL_NUMBER_CONCENTR', 0)
obs_kind_names(39) = obs_kind_type(KIND_CLOUD_FRACTION, 'KIND_CLOUD_FRACTION', 0)
obs_kind_names(40) = obs_kind_type(KIND_ICE_FRACTION, 'KIND_ICE_FRACTION', 0)
obs_kind_names(41) = obs_kind_type(KIND_RELATIVE_HUMIDITY, 'KIND_RELATIVE_HUMIDITY', 0)
obs_kind_names(42) = obs_kind_type(KIND_ELECTRON_DENSITY, 'KIND_ELECTRON_DENSITY', 0)
obs_kind_names(43) = obs_kind_type(KIND_1D_PARAMETER, 'KIND_1D_PARAMETER', 0)
obs_kind_names(44) = obs_kind_type(KIND_2D_PARAMETER, 'KIND_2D_PARAMETER', 0)
obs_kind_names(45) = obs_kind_type(KIND_3D_PARAMETER, 'KIND_3D_PARAMETER', 0)
obs_kind_names(46) = obs_kind_type(KIND_ATOMIC_OXYGEN_MIXING_RATIO, 'KIND_ATOMIC_OXYGEN_MIXING_RATIO', 0)
obs_kind_names(47) = obs_kind_type(KIND_MOLEC_OXYGEN_MIXING_RATIO, 'KIND_MOLEC_OXYGEN_MIXING_RATIO', 0)
obs_kind_names(48) = obs_kind_type(KIND_ALTIMETER_TENDENCY, 'KIND_ALTIMETER_TENDENCY', 0)
obs_kind_names(49) = obs_kind_type(KIND_PRECIPITABLE_WATER, 'KIND_PRECIPITABLE_WATER', 0)
obs_kind_names(50) = obs_kind_type(KIND_SALINITY, 'KIND_SALINITY', 0)
obs_kind_names(51) = obs_kind_type(KIND_U_CURRENT_COMPONENT, 'KIND_U_CURRENT_COMPONENT', 0)
obs_kind_names(52) = obs_kind_type(KIND_V_CURRENT_COMPONENT, 'KIND_V_CURRENT_COMPONENT', 0)
obs_kind_names(53) = obs_kind_type(KIND_SEA_SURFACE_HEIGHT, 'KIND_SEA_SURFACE_HEIGHT', 0)
obs_kind_names(54) = obs_kind_type(KIND_DRY_LAND, 'KIND_DRY_LAND', 0)
obs_kind_names(55) = obs_kind_type(KIND_SEA_SURFACE_PRESSURE, 'KIND_SEA_SURFACE_PRESSURE', 0)
obs_kind_names(56) = obs_kind_type(KIND_W_CURRENT_COMPONENT, 'KIND_W_CURRENT_COMPONENT', 0)
obs_kind_names(57) = obs_kind_type(KIND_OCCULTATION_REFRACTIVITY, 'KIND_OCCULTATION_REFRACTIVITY', 0)
obs_kind_names(58) = obs_kind_type(KIND_OCCULTATION_EXCESSPHASE, 'KIND_OCCULTATION_EXCESSPHASE', 0)
obs_kind_names(59) = obs_kind_type(KIND_GEOMETRIC_HEIGHT, 'KIND_GEOMETRIC_HEIGHT', 0)
obs_kind_names(60) = obs_kind_type(KIND_INFRARED_RADIANCE, 'KIND_INFRARED_RADIANCE', 0)
obs_kind_names(61) = obs_kind_type(KIND_INFRARED_BRIGHT_TEMP, 'KIND_INFRARED_BRIGHT_TEMP', 0)
obs_kind_names(62) = obs_kind_type(KIND_LANDMASK, 'KIND_LANDMASK', 0)
obs_kind_names(63) = obs_kind_type(KIND_EDGE_NORMAL_SPEED, 'KIND_EDGE_NORMAL_SPEED', 0)
obs_kind_names(64) = obs_kind_type(KIND_CLW_PATH, 'KIND_CLW_PATH', 0)
obs_kind_names(65) = obs_kind_type(KIND_WIND_TURBINE_POWER, 'KIND_WIND_TURBINE_POWER', 0)

obs_kind_names(70) = obs_kind_type(KIND_SKIN_TEMPERATURE, 'KIND_SKIN_TEMPERATURE', 0)
obs_kind_names(71) = obs_kind_type(KIND_NADIR_RADIANCE, 'KIND_NADIR_RADIANCE', 0)
obs_kind_names(72) = obs_kind_type(KIND_TRACER_1_MIXING_RATIO, 'KIND_TRACER_1_MIXING_RATIO', 0)
obs_kind_names(73) = obs_kind_type(KIND_TRACER_2_MIXING_RATIO, 'KIND_TRACER_2_MIXING_RATIO', 0)
obs_kind_names(74) = obs_kind_type(KIND_SOIL_TEMPERATURE, 'KIND_SOIL_TEMPERATURE', 0)
obs_kind_names(75) = obs_kind_type(KIND_SOIL_LIQUID_WATER, 'KIND_SOIL_LIQUID_WATER', 0)
obs_kind_names(76) = obs_kind_type(KIND_VERTICAL_VORTICITY, 'KIND_VERTICAL_VORTICITY', 0)
obs_kind_names(77) = obs_kind_type(KIND_SURFACE_ALBEDO, 'KIND_SURFACE_ALBEDO', 0)
obs_kind_names(78) = obs_kind_type(KIND_SURFACE_EMISSIVITY, 'KIND_SURFACE_EMISSIVITY', 0)
obs_kind_names(79) = obs_kind_type(KIND_DUST_OPACITY_7MB, 'KIND_DUST_OPACITY_7MB', 0)
obs_kind_names(80) = obs_kind_type(KIND_THC, 'KIND_THC', 0)
obs_kind_names(81) = obs_kind_type(KIND_VORTEX_LON, 'KIND_VORTEX_LON', 0)
obs_kind_names(82) = obs_kind_type(KIND_VORTEX_LAT, 'KIND_VORTEX_LAT', 0)
obs_kind_names(83) = obs_kind_type(KIND_VORTEX_PMIN, 'KIND_VORTEX_PMIN', 0)
obs_kind_names(84) = obs_kind_type(KIND_VORTEX_WMAX, 'KIND_VORTEX_WMAX', 0)
obs_kind_names(85) = obs_kind_type(KIND_EXNER_FUNCTION, 'KIND_EXNER_FUNCTION', 0)
obs_kind_names(86) = obs_kind_type(KIND_TURBULENT_KINETIC_ENERGY, 'KIND_TURBULENT_KINETIC_ENERGY', 0)
obs_kind_names(87) = obs_kind_type(KIND_TOTAL_PRECIPITABLE_WATER, 'KIND_TOTAL_PRECIPITABLE_WATER', 0)
obs_kind_names(88) = obs_kind_type(KIND_VERTLEVEL, 'KIND_VERTLEVEL', 0)
obs_kind_names(89) = obs_kind_type(KIND_MICROWAVE_BRIGHT_TEMP, 'KIND_MICROWAVE_BRIGHT_TEMP', 0)
obs_kind_names(90) = obs_kind_type(KIND_INTEGRATED_SULFATE, 'KIND_INTEGRATED_SULFATE', 0)
obs_kind_names(91) = obs_kind_type(KIND_INTEGRATED_DUST, 'KIND_INTEGRATED_DUST', 0)
obs_kind_names(92) = obs_kind_type(KIND_INTEGRATED_SMOKE, 'KIND_INTEGRATED_SMOKE', 0)
obs_kind_names(93) = obs_kind_type(KIND_INTEGRATED_SEASALT, 'KIND_INTEGRATED_SEASALT', 0)
obs_kind_names(94) = obs_kind_type(KIND_INTEGRATED_AOD, 'KIND_INTEGRATED_AOD', 0)
obs_kind_names(95) = obs_kind_type(KIND_SO2, 'KIND_SO2', 0)
obs_kind_names(96) = obs_kind_type(KIND_SULFATE, 'KIND_SULFATE', 0)
obs_kind_names(97) = obs_kind_type(KIND_DUST, 'KIND_DUST', 0)
obs_kind_names(98) = obs_kind_type(KIND_SMOKE, 'KIND_SMOKE', 0)
obs_kind_names(99) = obs_kind_type(KIND_SEASALT, 'KIND_SEASALT', 0)
obs_kind_names(100) = obs_kind_type(KIND_HAIL_MIXING_RATIO, 'KIND_HAIL_MIXING_RATIO', 0)
obs_kind_names(101) = obs_kind_type(KIND_HAIL_NUMBER_CONCENTR, 'KIND_HAIL_NUMBER_CONCENTR', 0)
obs_kind_names(102) = obs_kind_type(KIND_GRAUPEL_VOLUME, 'KIND_GRAUPEL_VOLUME', 0)
obs_kind_names(103) = obs_kind_type(KIND_HAIL_VOLUME, 'KIND_HAIL_VOLUME', 0)
obs_kind_names(104) = obs_kind_type(KIND_DIFFERENTIAL_REFLECTIVITY, 'KIND_DIFFERENTIAL_REFLECTIVITY', 0)
obs_kind_names(105) = obs_kind_type(KIND_SPECIFIC_DIFFERENTIAL_PHASE, 'KIND_SPECIFIC_DIFFERENTIAL_PHASE', 0)
obs_kind_names(106) = obs_kind_type(KIND_FLASH_RATE_2D, 'KIND_FLASH_RATE_2D', 0)

obs_kind_names(107) = obs_kind_type(KIND_SNOW_THICKNESS        ,'KIND_SNOW_THICKNESS', 0)
obs_kind_names(108) = obs_kind_type(KIND_SNOW_WATER            ,'KIND_SNOW_WATER', 0)
obs_kind_names(109) = obs_kind_type(KIND_SNOWCOVER_FRAC        ,'KIND_SNOWCOVER_FRAC', 0)
obs_kind_names(110) = obs_kind_type(KIND_LIQUID_WATER          ,'KIND_LIQUID_WATER', 0)
obs_kind_names(111) = obs_kind_type(KIND_ICE                   ,'KIND_ICE', 0)
obs_kind_names(112) = obs_kind_type(KIND_CARBON                ,'KIND_CARBON', 0)
obs_kind_names(113) = obs_kind_type(KIND_SOIL_CARBON           ,'KIND_SOIL_CARBON', 0)
obs_kind_names(114) = obs_kind_type(KIND_ROOT_CARBON           ,'KIND_ROOT_CARBON', 0)
obs_kind_names(115) = obs_kind_type(KIND_STEM_CARBON           ,'KIND_STEM_CARBON', 0)
obs_kind_names(116) = obs_kind_type(KIND_LEAF_CARBON           ,'KIND_LEAF_CARBON', 0)
obs_kind_names(117) = obs_kind_type(KIND_LEAF_AREA_INDEX       ,'KIND_LEAF_AREA_INDEX', 0)
obs_kind_names(118) = obs_kind_type(KIND_NET_CARBON_FLUX       ,'KIND_NET_CARBON_FLUX', 0)
obs_kind_names(119) = obs_kind_type(KIND_LATENT_HEAT_FLUX      ,'KIND_LATENT_HEAT_FLUX', 0)
obs_kind_names(120) = obs_kind_type(KIND_SENSIBLE_HEAT_FLUX    ,'KIND_SENSIBLE_HEAT_FLUX', 0)
obs_kind_names(121) = obs_kind_type(KIND_RADIATION             ,'KIND_RADIATION', 0)
obs_kind_names(122) = obs_kind_type(KIND_NET_CARBON_PRODUCTION ,'KIND_NET_CARBON_PRODUCTION', 0)
obs_kind_names(123) = obs_kind_type(KIND_NITROGEN              ,'KIND_NITROGEN', 0)
obs_kind_names(124) = obs_kind_type(KIND_SOIL_NITROGEN         ,'KIND_SOIL_NITROGEN', 0)
obs_kind_names(125) = obs_kind_type(KIND_ROOT_NITROGEN         ,'KIND_ROOT_NITROGEN', 0)
obs_kind_names(126) = obs_kind_type(KIND_STEM_NITROGEN         ,'KIND_STEM_NITROGEN', 0)
obs_kind_names(127) = obs_kind_type(KIND_LEAF_NITROGEN         ,'KIND_LEAF_NITROGEN', 0)
obs_kind_names(128) = obs_kind_type(KIND_WATER_TABLE_DEPTH     ,'KIND_WATER_TABLE_DEPTH', 0)
obs_kind_names(129) = obs_kind_type(KIND_FPAR                  ,'KIND_FPAR', 0)
obs_kind_names(130) = obs_kind_type(KIND_TOTAL_WATER_STORAGE   ,'KIND_TOTAL_WATER_STORAGE', 0)

obs_kind_names(140) = obs_kind_type(KIND_NEUTRON_INTENSITY     ,'KIND_NEUTRON_INTENSITY', 0)
obs_kind_names(141) = obs_kind_type(KIND_CANOPY_WATER          ,'KIND_CANOPY_WATER', 0)
obs_kind_names(142) = obs_kind_type(KIND_GROUND_HEAT_FLUX      ,'KIND_GROUND_HEAT_FLUX', 0)
obs_kind_names(143) = obs_kind_type(KIND_VERTICAL_TEC          ,'KIND_VERTICAL_TEC', 0)
obs_kind_names(144) = obs_kind_type(KIND_O_N2_COLUMN_DENSITY_RATIO, 'KIND_O_N2_COLUMN_DENSITY_RATIO', 0)

obs_kind_names(145) = obs_kind_type(KIND_AIR_TEMPERATURE,   'KIND_AIR_TEMPERATURE', 0)
obs_kind_names(145) = obs_kind_type(KIND_WATER_TEMPERATURE, 'KIND_WATER_TEMPERATURE', 0)

obs_kind_names(151) = obs_kind_type(KIND_O3,              'KIND_O3', 0)
obs_kind_names(153) = obs_kind_type(KIND_CO,              'KIND_CO', 0)
obs_kind_names(155) = obs_kind_type(KIND_NO,              'KIND_NO', 0)
obs_kind_names(156) = obs_kind_type(KIND_NO2,             'KIND_NO2', 0)

obs_kind_names(247) = obs_kind_type(KIND_CO2,             'KIND_CO2', 0)
obs_kind_names(248) = obs_kind_type(KIND_NH3,             'KIND_NH3', 0)
obs_kind_names(249) = obs_kind_type(KIND_CH4,             'KIND_CH4', 0)

obs_kind_names(251) = obs_kind_type(KIND_TEMPERATURE_ELECTRON  ,'KIND_TEMPERATURE_ELECTRON', 0)
obs_kind_names(252) = obs_kind_type(KIND_TEMPERATURE_ION       ,'KIND_TEMPERATURE_ION', 0)
obs_kind_names(253) = obs_kind_type(KIND_DENSITY_NEUTRAL_O3P   ,'KIND_DENSITY_NEUTRAL_O3P', 0)
obs_kind_names(254) = obs_kind_type(KIND_DENSITY_NEUTRAL_O2    ,'KIND_DENSITY_NEUTRAL_O2', 0)
obs_kind_names(255) = obs_kind_type(KIND_DENSITY_NEUTRAL_N2    ,'KIND_DENSITY_NEUTRAL_N2', 0)
obs_kind_names(256) = obs_kind_type(KIND_DENSITY_NEUTRAL_N4S   ,'KIND_DENSITY_NEUTRAL_N4S', 0)
obs_kind_names(257) = obs_kind_type(KIND_DENSITY_NEUTRAL_NO    ,'KIND_DENSITY_NEUTRAL_NO', 0)
obs_kind_names(258) = obs_kind_type(KIND_DENSITY_NEUTRAL_N2D   ,'KIND_DENSITY_NEUTRAL_N2D', 0)
obs_kind_names(259) = obs_kind_type(KIND_DENSITY_NEUTRAL_N2P   ,'KIND_DENSITY_NEUTRAL_N2P', 0)
obs_kind_names(260) = obs_kind_type(KIND_DENSITY_NEUTRAL_H     ,'KIND_DENSITY_NEUTRAL_H', 0)
obs_kind_names(261) = obs_kind_type(KIND_DENSITY_NEUTRAL_HE    ,'KIND_DENSITY_NEUTRAL_HE', 0)
obs_kind_names(262) = obs_kind_type(KIND_DENSITY_NEUTRAL_CO2   ,'KIND_DENSITY_NEUTRAL_CO2', 0)
obs_kind_names(263) = obs_kind_type(KIND_DENSITY_NEUTRAL_O1D   ,'KIND_DENSITY_NEUTRAL_O1D', 0)
obs_kind_names(264) = obs_kind_type(KIND_DENSITY_ION_O4SP      ,'KIND_DENSITY_ION_O4SP', 0)
obs_kind_names(265) = obs_kind_type(KIND_DENSITY_ION_O2P       ,'KIND_DENSITY_ION_O2P', 0)
obs_kind_names(266) = obs_kind_type(KIND_DENSITY_ION_N2P       ,'KIND_DENSITY_ION_N2P', 0)
obs_kind_names(267) = obs_kind_type(KIND_DENSITY_ION_NP        ,'KIND_DENSITY_ION_NP', 0)
obs_kind_names(268) = obs_kind_type(KIND_DENSITY_ION_NOP       ,'KIND_DENSITY_ION_NOP', 0)
obs_kind_names(269) = obs_kind_type(KIND_DENSITY_ION_O2DP      ,'KIND_DENSITY_ION_O2DP', 0)
obs_kind_names(270) = obs_kind_type(KIND_DENSITY_ION_O2PP      ,'KIND_DENSITY_ION_O2PP', 0)
obs_kind_names(271) = obs_kind_type(KIND_DENSITY_ION_HP        ,'KIND_DENSITY_ION_HP', 0)
obs_kind_names(272) = obs_kind_type(KIND_DENSITY_ION_HEP       ,'KIND_DENSITY_ION_HEP', 0)
obs_kind_names(273) = obs_kind_type(KIND_DENSITY_ION_E         ,'KIND_DENSITY_ION_E', 0)
obs_kind_names(274) = obs_kind_type(KIND_VELOCITY_U            ,'KIND_VELOCITY_U', 0)
obs_kind_names(275) = obs_kind_type(KIND_VELOCITY_V            ,'KIND_VELOCITY_V', 0)
obs_kind_names(276) = obs_kind_type(KIND_VELOCITY_W            ,'KIND_VELOCITY_W', 0)
obs_kind_names(277) = obs_kind_type(KIND_VELOCITY_U_ION        ,'KIND_VELOCITY_U_ION', 0)
obs_kind_names(278) = obs_kind_type(KIND_VELOCITY_V_ION        ,'KIND_VELOCITY_V_ION', 0)
obs_kind_names(279) = obs_kind_type(KIND_VELOCITY_W_ION        ,'KIND_VELOCITY_W_ION', 0)
obs_kind_names(280) = obs_kind_type(KIND_VELOCITY_VERTICAL_O3P ,'KIND_VELOCITY_VERTICAL_O3P', 0)
obs_kind_names(281) = obs_kind_type(KIND_VELOCITY_VERTICAL_O2  ,'KIND_VELOCITY_VERTICAL_O2', 0)
obs_kind_names(282) = obs_kind_type(KIND_VELOCITY_VERTICAL_N2  ,'KIND_VELOCITY_VERTICAL_N2', 0)
obs_kind_names(283) = obs_kind_type(KIND_VELOCITY_VERTICAL_N4S ,'KIND_VELOCITY_VERTICAL_N4S', 0)
obs_kind_names(284) = obs_kind_type(KIND_VELOCITY_VERTICAL_NO  ,'KIND_VELOCITY_VERTICAL_NO', 0)
obs_kind_names(285) = obs_kind_type(KIND_GND_GPS_VTEC          ,'KIND_GND_GPS_VTEC', 0)
obs_kind_names(286) = obs_kind_type(KIND_DENSITY_ION_OP        ,'KIND_DENSITY_ION_OP', 0)

obs_kind_names(300) = obs_kind_type(KIND_BRIGHTNESS_TEMPERATURE,'KIND_BRIGHTNESS_TEMPERATURE', 0)
obs_kind_names(301) = obs_kind_type(KIND_VEGETATION_TEMPERATURE,'KIND_VEGETATION_TEMPERATURE', 0)
obs_kind_names(302) = obs_kind_type(KIND_CANOPY_HEIGHT         ,'KIND_CANOPY_HEIGHT', 0)
obs_kind_names(303) = obs_kind_type(KIND_FPAR_DIRECT           ,'KIND_FPAR_DIRECT', 0)
obs_kind_names(304) = obs_kind_type(KIND_FPAR_DIFFUSE          ,'KIND_FPAR_DIFFUSE', 0)
obs_kind_names(305) = obs_kind_type(KIND_FPAR_SUNLIT_DIRECT    ,'KIND_FPAR_SUNLIT_DIRECT', 0)
obs_kind_names(306) = obs_kind_type(KIND_FPAR_SUNLIT_DIFFUSE   ,'KIND_FPAR_SUNLIT_DIFFUSE', 0)
obs_kind_names(307) = obs_kind_type(KIND_FPAR_SHADED_DIRECT    ,'KIND_FPAR_SHADED_DIRECT', 0)
obs_kind_names(308) = obs_kind_type(KIND_FPAR_SHADED_DIFFUSE   ,'KIND_FPAR_SHADED_DIFFUSE', 0)
obs_kind_names(309) = obs_kind_type(KIND_FPSN                  ,'KIND_FPSN', 0)
obs_kind_names(310) = obs_kind_type(KIND_FSIF                  ,'KIND_FSIF', 0)
...
function get_fo_component(obs_type_ind)

! Returns observation type forward operator component number

integer, intent(in) :: obs_type_ind
integer :: get_fo_component
...
if (obs_type_ind < 1 .or. obs_type_ind > max_obs_specific) then
   write(msg_string,'(A,I6,A,I6)') 'specific type number ', obs_type_ind, &
                                   ' must be between 1 and ', max_obs_specific
   call error_handler(E_ERR, 'get_fo_component', msg_string, &
                      source, revision, revdate)
endif

get_fo_component = obs_type_info(obs_type_ind)%FO_component

end function get_fo_component
