...
!
! $Id: DEFAULT_obs_kind_mod.F90 11937 2017-09-18 22:53:48Z mizzi@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/mizzi/obs_kind/DEFAULT_obs_kind_mod.F90 $"
character(len=32 ), parameter :: revision = "$Revision: 11937 $"
character(len=128), parameter :: revdate  = "$Date: 2017-09-18 16:53:48 -0600 (Mon, 18 Sep 2017) $"
...
obs_kind_names(152) = obs_kind_type(KIND_CO, 'KIND_CO')
obs_kind_names(153) = obs_kind_type(KIND_NO, 'KIND_NO')
obs_kind_names(154) = obs_kind_type(KIND_NO2, 'KIND_NO2')
...
obs_kind_names(159) = obs_kind_type(KIND_MEK, 'KIND_MEK')
obs_kind_names(160) = obs_kind_type(KIND_ALD, 'KIND_ALD')
obs_kind_names(161) = obs_kind_type(KIND_CH3O2, 'KIND_CH3O2')
obs_kind_names(162) = obs_kind_type(KIND_C3H8, 'KIND_C3H8')
obs_kind_names(163) = obs_kind_type(KIND_C2H6, 'KIND_C2H6')
obs_kind_names(164) = obs_kind_type(KIND_ACET, 'KIND_ACET')
obs_kind_names(165) = obs_kind_type(KIND_HCHO, 'KIND_HCHO')
obs_kind_names(166) = obs_kind_type(KIND_C2H4, 'KIND_C2H4')
obs_kind_names(167) = obs_kind_type(KIND_C3H6, 'KIND_C3H6')
obs_kind_names(168) = obs_kind_type(KIND_TOL, 'KIND_TOL')
obs_kind_names(169) = obs_kind_type(KIND_MVK, 'KIND_MVK')
obs_kind_names(170) = obs_kind_type(KIND_BIGALK, 'KIND_BIGALK')
obs_kind_names(171) = obs_kind_type(KIND_ISOPR, 'KIND_ISOPR')
obs_kind_names(172) = obs_kind_type(KIND_MACR, 'KIND_MACR')
...
obs_kind_names(176) = obs_kind_type(KIND_BC1, 'KIND_BC1')
obs_kind_names(177) = obs_kind_type(KIND_BC2, 'KIND_BC2')
...
obs_kind_names(181) = obs_kind_type(KIND_DST01, 'KIND_DST01')
obs_kind_names(182) = obs_kind_type(KIND_DST02, 'KIND_DST02')
obs_kind_names(183) = obs_kind_type(KIND_DST03, 'KIND_DST03')
obs_kind_names(184) = obs_kind_type(KIND_DST04, 'KIND_DST04')
obs_kind_names(185) = obs_kind_type(KIND_DST05, 'KIND_DST05')
obs_kind_names(186) = obs_kind_type(KIND_SO4, 'KIND_SO4')
obs_kind_names(187) = obs_kind_type(KIND_SSLT01, 'KIND_SSLT01')
obs_kind_names(188) = obs_kind_type(KIND_SSLT02, 'KIND_SSLT02')
obs_kind_names(189) = obs_kind_type(KIND_SSLT03, 'KIND_SSLT03')
obs_kind_names(190) = obs_kind_type(KIND_SSLT04, 'KIND_SSLT04')
obs_kind_names(191) = obs_kind_type(KIND_TAUAER1, 'KIND_TAUAER1')
obs_kind_names(192) = obs_kind_type(KIND_TAUAER2, 'KIND_TAUAER2')
obs_kind_names(193) = obs_kind_type(KIND_TAUAER3, 'KIND_TAUAER3')
obs_kind_names(194) = obs_kind_type(KIND_TAUAER4, 'KIND_TAUAER4')
obs_kind_names(195) = obs_kind_type(KIND_PM25, 'KIND_PM25')
obs_kind_names(196) = obs_kind_type(KIND_PM10, 'KIND_PM10')
obs_kind_names(197) = obs_kind_type(KIND_PM2_5_DRY, 'KIND_PM2_5_DRY')
obs_kind_names(198) = obs_kind_type(KIND_NOy, 'KIND_NOy')
obs_kind_names(199) = obs_kind_type(KIND_PB, 'KIND_PB')
obs_kind_names(200) = obs_kind_type(KIND_NMOC, 'KIND_NMOC')
!
! LXL/APM +++
obs_kind_names(201) = obs_kind_type(KIND_E_CO,'KIND_P25')
obs_kind_names(202) = obs_kind_type(KIND_E_CO,'KIND_P10')
obs_kind_names(203) = obs_kind_type(KIND_E_NO,'KIND_E_CO')
obs_kind_names(204) = obs_kind_type(KIND_E_NO2,'KIND_E_NO')
obs_kind_names(205) = obs_kind_type(KIND_E_SO2,'KIND_E_NO2')
obs_kind_names(206) = obs_kind_type(KIND_E_OC,'KIND_E_SO2')
obs_kind_names(207) = obs_kind_type(KIND_E_BC,'KIND_E_SO4')
obs_kind_names(208) = obs_kind_type(KIND_E_PM25,'KIND_E_PM25')
obs_kind_names(209) = obs_kind_type(KIND_E_PM10,'KIND_E_PM10')
obs_kind_names(210) = obs_kind_type(KIND_E_BC,'KIND_E_BC')
obs_kind_names(211) = obs_kind_type(KIND_E_OC,'KIND_E_OC')
obs_kind_names(212) = obs_kind_type(KIND_EBU_CO,'KIND_EBU_CO')
obs_kind_names(213) = obs_kind_type(KIND_EBU_NO,'KIND_EBU_NO')
obs_kind_names(214) = obs_kind_type(KIND_EBU_NO2,'KIND_EBU_NO2')
obs_kind_names(215) = obs_kind_type(KIND_EBU_SO2,'KIND_EBU_SO2')
obs_kind_names(216) = obs_kind_type(KIND_EBU_SO4,'KIND_EBU_SO4')
obs_kind_names(217) = obs_kind_type(KIND_EBU_OC,'KIND_EBU_OC')
obs_kind_names(218) = obs_kind_type(KIND_EBU_BC,'KIND_EBU_BC')
obs_kind_names(219) = obs_kind_type(KIND_EBU_c2h4,'KIND_EBU_c2h4')
obs_kind_names(220) = obs_kind_type(KIND_EBU_ch2o,'KIND_EBU_ch2o')
obs_kind_names(221) = obs_kind_type(KIND_EBU_ch3oh,'KIND_EBU_ch3oh')
! APM/LXL ---
!
obs_kind_names(248) = obs_kind_type(KIND_CO2,             'KIND_CO2')
obs_kind_names(249) = obs_kind_type(KIND_NH3,             'KIND_NH3')
obs_kind_names(250) = obs_kind_type(KIND_CH4,             'KIND_CH4')
...
! $Id: DEFAULT_obs_kind_mod.F90 11937 2017-09-18 22:53:48Z mizzi@ucar.edu $
! $Revision: 11937 $
! $Date: 2017-09-18 16:53:48 -0600 (Mon, 18 Sep 2017) $
