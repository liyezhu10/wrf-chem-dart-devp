...
!
! LXL/APM +++
obs_kind_names(200) = obs_kind_type(KIND_P25,'KIND_P25')
obs_kind_names(201) = obs_kind_type(KIND_P10,'KIND_P10')
obs_kind_names(202) = obs_kind_type(KIND_E_CO,'KIND_E_CO')
obs_kind_names(203) = obs_kind_type(KIND_E_NO,'KIND_E_NO')
obs_kind_names(204) = obs_kind_type(KIND_E_NO2,'KIND_E_NO2')
obs_kind_names(205) = obs_kind_type(KIND_E_SO2,'KIND_E_SO2')
obs_kind_names(206) = obs_kind_type(KIND_E_SO4,'KIND_E_SO4')
obs_kind_names(207) = obs_kind_type(KIND_E_PM25,'KIND_E_PM25')
obs_kind_names(208) = obs_kind_type(KIND_E_PM10,'KIND_E_PM10')
obs_kind_names(209) = obs_kind_type(KIND_E_BC,'KIND_E_BC')
obs_kind_names(210) = obs_kind_type(KIND_E_OC,'KIND_E_OC')
obs_kind_names(211) = obs_kind_type(KIND_EBU_CO,'KIND_EBU_CO')
obs_kind_names(212) = obs_kind_type(KIND_EBU_NO,'KIND_EBU_NO')
obs_kind_names(213) = obs_kind_type(KIND_EBU_NO2,'KIND_EBU_NO2')
obs_kind_names(214) = obs_kind_type(KIND_EBU_SO2,'KIND_EBU_SO2')
obs_kind_names(215) = obs_kind_type(KIND_EBU_SO4,'KIND_EBU_SO4')
obs_kind_names(216) = obs_kind_type(KIND_EBU_OC,'KIND_EBU_OC')
obs_kind_names(217) = obs_kind_type(KIND_EBU_BC,'KIND_EBU_BC')
obs_kind_names(218) = obs_kind_type(KIND_EBU_C2H4,'KIND_EBU_C2H4')
obs_kind_names(219) = obs_kind_type(KIND_EBU_CH2O,'KIND_EBU_CH2O')
obs_kind_names(220) = obs_kind_type(KIND_EBU_CH3OH,'KIND_EBU_CH3OH')
! APM/LXL ---
!
