...
integer, parameter, public :: &
  ...
  KIND_FPSN                          = 309, &
  KIND_FSIF                          = 310, &
  KIND_LAND_COVER_TYPE               = 311, &
  KIND_SURFACE_CONDUCTANCE           = 312, &  ! gs   m/s
  KIND_SNOW_BULK_DENSITY             = 313, &  ! rho_snow   kg/m^3
  KIND_SOIL_MOISTURE_FRACTION        = 314     ! sthuf  [0,1] 

!! PRIVATE ONLY TO THIS MODULE. see comment below near the max_obs_specific
!! declaration.

integer, parameter :: max_obs_generic = 314
...
obs_kind_names(311) = obs_kind_type(KIND_LAND_COVER_TYPE       ,'KIND_LAND_COVER_TYPE')
obs_kind_names(312) = obs_kind_type(KIND_SURFACE_CONDUCTANCE   ,'KIND_SURFACE_CONDUCTANCE')
obs_kind_names(313) = obs_kind_type(KIND_SNOW_BULK_DENSITY     ,'KIND_SNOW_BULK_DENSITY')
obs_kind_names(314) = obs_kind_type(KIND_SOIL_MOISTURE_FRACTION,'KIND_SOIL_MOISTURE_FRACTION')
