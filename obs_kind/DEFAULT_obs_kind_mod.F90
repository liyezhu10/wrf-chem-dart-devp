...
integer, parameter, public :: &
  ...
  KIND_STREAM_HEIGHT                 = 293, &
  KIND_GROUND_SURF_TEMPERATURE       = 294, &
  KIND_CANOPY_TEMPERATURE            = 295
...
obs_kind_names(290) = obs_kind_type(KIND_STREAM_FLOW           ,'KIND_STREAM_FLOW')
obs_kind_names(291) = obs_kind_type(KIND_SURFACE_HEAD          ,'KIND_SURFACE_HEAD')
obs_kind_names(292) = obs_kind_type(KIND_DEEP_GROUNDWATER_LEVEL,'KIND_DEEP_GROUNDWATER_LEVEL')
obs_kind_names(293) = obs_kind_type(KIND_STREAM_HEIGHT         ,'KIND_STREAM_HEIGHT')
obs_kind_names(294) = obs_kind_type(KIND_GROUND_SURF_TEMPERATURE,'KIND_GROUND_SURF_TEMPERATURE')
obs_kind_names(295) = obs_kind_type(KIND_CANOPY_TEMPERATURE     ,'KIND_CANOPY_TEMPERATURE')
...
obs_kind_names(357) = obs_kind_type(KIND_MEAN_DYNAMIC_TOPOGRAPHY,'KIND_MEAN_DYNAMIC_TOPOGRAPHY')
