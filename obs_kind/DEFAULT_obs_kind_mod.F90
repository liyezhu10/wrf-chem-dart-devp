...
! land kinds for JULES 
integer, parameter, public :: &
    KIND_LAND_COVER_TYPE             = 300, &
    KIND_SURFACE_CONDUCTANCE         = 301, &  ! gs   m/s
    KIND_SNOW_BULK_DENSITY           = 302, &  ! rho_snow   kg/m^3
    KIND_SOIL_MOISTURE_FRACTION      = 303     ! sthuf  [0,1] 

!! PRIVATE ONLY TO THIS MODULE. see comment below near the max_obs_specific
!! declaration.

integer, parameter :: max_obs_generic = 303
...
obs_kind_names(300) = obs_kind_type(KIND_LAND_COVER_TYPE        ,'KIND_LAND_COVER_TYPE')
obs_kind_names(301) = obs_kind_type(KIND_SURFACE_CONDUCTANCE    ,'KIND_SURFACE_CONDUCTANCE')
obs_kind_names(302) = obs_kind_type(KIND_SNOW_BULK_DENSITY      ,'KIND_SNOW_BULK_DENSITY')
obs_kind_names(303) = obs_kind_type(KIND_SOIL_MOISTURE_FRACTION ,'KIND_SOIL_MOISTURE_FRACTION')
