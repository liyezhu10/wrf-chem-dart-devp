...
public :: location_type, get_location, set_location, &
          ...
          VERTISLEVEL, VERTISPRESSURE, VERTISHEIGHT, vert_is_scale_height, &
...
character(len = 129), parameter :: LocationStorageOrder = "Vertical"
character(len = 129), parameter :: LocationUnits = "which_vert"
...
!--------------------------------------------------------------------
!> does this location mod have multiple vertical components?
...
! Given a location, return true if vertical coordinate is scale_height, else false
