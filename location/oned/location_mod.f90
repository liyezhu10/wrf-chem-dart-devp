...
public :: location_type, get_location, set_location, &
          ...
          vert_is_surface, has_vertical_localization, get_vert, set_vert, &
          set_which_vert, vert_is_scale_height
...
character(len = 129), parameter :: LocationStorageOrder = "X"
character(len = 129), parameter :: LocationUnits = "none"
