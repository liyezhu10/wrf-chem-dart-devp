...
direct_netcdf_read, direct_netcdf_write, use_restart_list, restart_list_file
...
! restart_list_file(1) = "restart_files.txt"
! restart_list_file(2) = "history_files.txt"
! restart_list_file(3) = "history_vector_files.txt"
...
write(*,*) "ens   size = ", ens_handle%num_copies - ens_handle%num_extras
...
call mark_missing_r8(ens_handle)
