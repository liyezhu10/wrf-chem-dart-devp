...
!
! $Id: state_vector_io_mod.f90 10275 2016-05-10 23:20:45Z hendric $
...
character(len=256), parameter :: source   = &
   "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/branches/pda/io/state_vector_io_mod.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 10275 $"
character(len=128), parameter :: revdate  = "$Date: 2016-05-10 17:20:45 -0600 (Tue, 10 May 2016) $"
...
if(use_time_from_file) then
    do ncopies =1, state_ens_handle%my_num_copies
        time = read_model_time(get_input_file(file_info%restart_files_in, ncopies,1)) ! Any of the restarts?
        state_ens_handle%time(ncopies) = time
    enddo
endif
