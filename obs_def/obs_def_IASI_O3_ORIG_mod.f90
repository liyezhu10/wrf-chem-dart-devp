...
use      location_mod, only : location_type, set_location, get_location, &
                              VERTISHEIGHT, VERTISPRESSURE, VERTISLEVEL
...
integer  :: iasi_nlevels(   MAX_IASI_O3_OBS)          ! number of levels used
real(r8) :: avg_kernel(     MAX_IASI_O3_OBS,IASI_DIM) ! kernel -- transformed and scaled
real(r8) :: iasi_air_column(MAX_IASI_O3_OBS,IASI_DIM) ! iasi retrieval air column profile
real(r8) :: iasi_heights(   MAX_IASI_O3_OBS,IASI_DIM) ! iasi retrieval heights
real(r8) :: iasi_prior_prof(MAX_IASI_O3_OBS,IASI_DIM) ! iasi retrieval prior profile

!real(r8) :: iasi_air_column((MAX_IASI_O3_OBS)
...
real(r8), intent(in) :: prior_prof(IASI_DIM)
