...
!
! $Id: obs_def_AIRNOW_PM25_mod.f90 7039 2014-07-02 22:00:57Z mizzi $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/mizzi/obs_def/obs_def_AIRNOW_PM25_mod.f90 $"
