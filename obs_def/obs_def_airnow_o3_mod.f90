...
!   use obs_def_airnow_mod, only : get_expected_airnow_o3
...
!   case(AIRNOW_O3)
!        call get_expected_airnow_o3(state, location, obs_val, istatus) 
...
! Ozone at this location - this calls the model_mod code.
call interpolate(state_vector, location, KIND_O3, o3_val, istatus)
if (istatus /= 0) then
   o3_val = missing_r8
   return
endif
