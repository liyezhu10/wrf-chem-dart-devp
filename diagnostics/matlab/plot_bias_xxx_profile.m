...
ges_bias = plotdat.ges_bias(:,plotdat.indices,plotdat.region);
anl_bias = plotdat.anl_bias(:,plotdat.indices,plotdat.region);
...
if (isfinite(sum(anl_Nposs)))
   h3 = line(anl_bias,plotdat.level);
   ...
   h = legend([h1,h2], str_pr_bias, str_pr_other, 'Location', 'NorthWest');
end
