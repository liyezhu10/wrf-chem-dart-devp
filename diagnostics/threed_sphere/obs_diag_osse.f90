...
!
! $Id: obs_diag.f90 6237 2013-06-10 22:35:40Z thoar $

program obs_diag_osse
...
character(len=256), parameter :: source   = &
   "$URL: https://subversion.ucar.edu/DAReS/DART/branches/development/diagnostics/threed_sphere/obs_diag_osse.f90 $"
character(len=32 ), parameter :: revision = "$Revision: 6237 $"
character(len=128), parameter :: revdate  = "$Date: 2013-06-10 16:35:40 -0600 (Mon, 10 Jun 2013) $"
...
!OSSE         obs_error_variance = get_obs_def_error_variance(obs_def)
...
!OSSE   if(index(metadata,'observation'              ) > 0)              obs_index = i
...
else if ( which_vert(flav) == VERTISHEIGHT .or. &
...
! TJH FIXME TESTME : remove duplicate levels from user input.
...
do i = 2,SIZE(mydata)
   ...
   elseif (any(mydata(i) == temparray(1:n))) then
      ...
      call error_handler(E_MSG,'RemoveDuplicates', &
...
end program obs_diag_osse

! <next few lines under version control, do not edit>
! $URL: https://subversion.ucar.edu/DAReS/DART/branches/development/diagnostics/threed_sphere/obs_diag.f90 $
! $Id: obs_diag.f90 6237 2013-06-10 22:35:40Z thoar $
! $Revision: 6237 $
