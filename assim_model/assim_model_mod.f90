...
subroutine interpolate(x, location, loctype, obs_vals, obs_mytags, istatus, optionals )
!---------------------------------------------------------------------
!
...
integer,          intent(inout) :: obs_mytags
integer,            intent(out) :: istatus 
real(r8), dimension(:), optional, intent(in) :: optionals

istatus = 0

call model_interpolate(x, location, loctype, obs_vals, obs_mytags, istatus, optionals)
