...
use      types_mod, only : r8, DEG2RAD, RAD2DEG, PI, i8, MISSING_R8
...
character(len=64), parameter :: LocationName = "loc2Dsphere"
character(len=64), parameter :: LocationLName = &
                                   "twod sphere locations: lon, lat"
character(len=64), parameter :: LocationStorageOrder = "lon lat"
character(len=64), parameter :: LocationUnits = "degrees degrees"
