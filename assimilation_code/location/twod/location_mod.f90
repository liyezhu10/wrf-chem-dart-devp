...
character(len=64), parameter :: LocationName = "loc2D"
character(len=64), parameter :: LocationLName = "twod cyclic locations: x, y"
character(len=64), parameter :: LocationStorageOrder = "X Y"
character(len=64), parameter :: LocationUnits = "none none"
