...
do i = 0, max_defined_quantities
   obs_qty_names(i) = obs_qty_type(i, 'UNKNOWN')
enddo

obs_qty_names( 0) = obs_qty_type(QTY_STATE_VARIABLE, 'QTY_STATE_VARIABLE')
obs_qty_names( 1) = obs_qty_type(QTY_U_WIND_COMPONENT, 'QTY_U_WIND_COMPONENT')
obs_qty_names( 2) = obs_qty_type(QTY_V_WIND_COMPONENT, 'QTY_V_WIND_COMPONENT')
obs_qty_names( 3) = obs_qty_type(QTY_SURFACE_PRESSURE, 'QTY_SURFACE_PRESSURE')
obs_qty_names( 4) = obs_qty_type(QTY_TEMPERATURE, 'QTY_TEMPERATURE')
obs_qty_names( 5) = obs_qty_type(QTY_SPECIFIC_HUMIDITY, 'QTY_SPECIFIC_HUMIDITY')
obs_qty_names( 6) = obs_qty_type(QTY_PRESSURE, 'QTY_PRESSURE')
obs_qty_names( 7) = obs_qty_type(QTY_VERTICAL_VELOCITY, 'QTY_VERTICAL_VELOCITY')
obs_qty_names( 8) = obs_qty_type(QTY_RAINWATER_MIXING_RATIO, 'QTY_RAINWATER_MIXING_RATIO')
obs_qty_names( 9) = obs_qty_type(QTY_DEWPOINT, 'QTY_DEWPOINT')
obs_qty_names(10) = obs_qty_type(QTY_DENSITY, 'QTY_DENSITY')
obs_qty_names(11) = obs_qty_type(QTY_VELOCITY, 'QTY_VELOCITY')
obs_qty_names(12) = obs_qty_type(QTY_RADAR_REFLECTIVITY, 'QTY_RADAR_REFLECTIVITY')
obs_qty_names(13) = obs_qty_type(QTY_1D_INTEGRAL, 'QTY_1D_INTEGRAL')
obs_qty_names(14) = obs_qty_type(QTY_GRAUPEL_MIXING_RATIO, 'QTY_GRAUPEL_MIXING_RATIO')
obs_qty_names(15) = obs_qty_type(QTY_SNOW_MIXING_RATIO, 'QTY_SNOW_MIXING_RATIO')
obs_qty_names(16) = obs_qty_type(QTY_GPSRO, 'QTY_GPSRO')
obs_qty_names(17) = obs_qty_type(QTY_CLOUD_LIQUID_WATER, 'QTY_CLOUD_LIQUID_WATER')
obs_qty_names(18) = obs_qty_type(QTY_CLOUD_ICE, 'QTY_CLOUD_ICE')
obs_qty_names(19) = obs_qty_type(QTY_CONDENSATIONAL_HEATING, 'QTY_CONDENSATIONAL_HEATING')
obs_qty_names(20) = obs_qty_type(QTY_VAPOR_MIXING_RATIO, 'QTY_VAPOR_MIXING_RATIO')
obs_qty_names(21) = obs_qty_type(QTY_ICE_NUMBER_CONCENTRATION, 'QTY_ICE_NUMBER_CONCENTRATION')
obs_qty_names(22) = obs_qty_type(QTY_GEOPOTENTIAL_HEIGHT, 'QTY_GEOPOTENTIAL_HEIGHT')
obs_qty_names(23) = obs_qty_type(QTY_POTENTIAL_TEMPERATURE, 'QTY_POTENTIAL_TEMPERATURE')
obs_qty_names(24) = obs_qty_type(QTY_SOIL_MOISTURE, 'QTY_SOIL_MOISTURE')
obs_qty_names(25) = obs_qty_type(QTY_SURFACE_ELEVATION, 'QTY_SURFACE_ELEVATION')
obs_qty_names(26) = obs_qty_type(QTY_GRAV_WAVE_DRAG_EFFIC, 'QTY_GRAV_WAVE_DRAG_EFFIC')
obs_qty_names(27) = obs_qty_type(QTY_GRAV_WAVE_STRESS_FRACTION, 'QTY_GRAV_WAVE_STRESS_FRACTION')
obs_qty_names(28) = obs_qty_type(QTY_TRACER_SOURCE, 'QTY_TRACER_SOURCE')
obs_qty_names(29) = obs_qty_type(QTY_TRACER_CONCENTRATION, 'QTY_TRACER_CONCENTRATION')
obs_qty_names(30) = obs_qty_type(QTY_MEAN_SOURCE, 'QTY_MEAN_SOURCE')
obs_qty_names(31) = obs_qty_type(QTY_SOURCE_PHASE, 'QTY_SOURCE_PHASE')
obs_qty_names(32) = obs_qty_type(QTY_POWER_WEIGHTED_FALL_SPEED, 'QTY_POWER_WEIGHTED_FALL_SPEED')
obs_qty_names(33) = obs_qty_type(QTY_CLOUDWATER_MIXING_RATIO, 'QTY_CLOUDWATER_MIXING_RATIO')
obs_qty_names(34) = obs_qty_type(QTY_ICE_MIXING_RATIO, 'QTY_ICE_MIXING_RATIO')
obs_qty_names(35) = obs_qty_type(QTY_DROPLET_NUMBER_CONCENTR, 'QTY_DROPLET_NUMBER_CONCENTR')
obs_qty_names(36) = obs_qty_type(QTY_SNOW_NUMBER_CONCENTR, 'QTY_SNOW_NUMBER_CONCENTR')
obs_qty_names(37) = obs_qty_type(QTY_RAIN_NUMBER_CONCENTR, 'QTY_RAIN_NUMBER_CONCENTR')
obs_qty_names(38) = obs_qty_type(QTY_GRAUPEL_NUMBER_CONCENTR, 'QTY_GRAUPEL_NUMBER_CONCENTR')
obs_qty_names(39) = obs_qty_type(QTY_CLOUD_FRACTION, 'QTY_CLOUD_FRACTION')
obs_qty_names(40) = obs_qty_type(QTY_ICE_FRACTION, 'QTY_ICE_FRACTION')
obs_qty_names(41) = obs_qty_type(QTY_RELATIVE_HUMIDITY, 'QTY_RELATIVE_HUMIDITY')
obs_qty_names(42) = obs_qty_type(QTY_ELECTRON_DENSITY, 'QTY_ELECTRON_DENSITY')
obs_qty_names(43) = obs_qty_type(QTY_1D_PARAMETER, 'QTY_1D_PARAMETER')
obs_qty_names(44) = obs_qty_type(QTY_2D_PARAMETER, 'QTY_2D_PARAMETER')
obs_qty_names(45) = obs_qty_type(QTY_3D_PARAMETER, 'QTY_3D_PARAMETER')
obs_qty_names(46) = obs_qty_type(QTY_ATOMIC_OXYGEN_MIXING_RATIO, 'QTY_ATOMIC_OXYGEN_MIXING_RATIO')
obs_qty_names(47) = obs_qty_type(QTY_MOLEC_OXYGEN_MIXING_RATIO, 'QTY_MOLEC_OXYGEN_MIXING_RATIO')
obs_qty_names(48) = obs_qty_type(QTY_ALTIMETER_TENDENCY, 'QTY_ALTIMETER_TENDENCY')
obs_qty_names(49) = obs_qty_type(QTY_PRECIPITABLE_WATER, 'QTY_PRECIPITABLE_WATER')
obs_qty_names(50) = obs_qty_type(QTY_SALINITY, 'QTY_SALINITY')
obs_qty_names(51) = obs_qty_type(QTY_U_CURRENT_COMPONENT, 'QTY_U_CURRENT_COMPONENT')
obs_qty_names(52) = obs_qty_type(QTY_V_CURRENT_COMPONENT, 'QTY_V_CURRENT_COMPONENT')
obs_qty_names(53) = obs_qty_type(QTY_SEA_SURFACE_HEIGHT, 'QTY_SEA_SURFACE_HEIGHT')
obs_qty_names(54) = obs_qty_type(QTY_DRY_LAND, 'QTY_DRY_LAND')
obs_qty_names(55) = obs_qty_type(QTY_SEA_SURFACE_PRESSURE, 'QTY_SEA_SURFACE_PRESSURE')
obs_qty_names(56) = obs_qty_type(QTY_W_CURRENT_COMPONENT, 'QTY_W_CURRENT_COMPONENT')
obs_qty_names(57) = obs_qty_type(QTY_OCCULTATION_REFRACTIVITY, 'QTY_OCCULTATION_REFRACTIVITY')
obs_qty_names(58) = obs_qty_type(QTY_OCCULTATION_EXCESSPHASE, 'QTY_OCCULTATION_EXCESSPHASE')
obs_qty_names(59) = obs_qty_type(QTY_GEOMETRIC_HEIGHT, 'QTY_GEOMETRIC_HEIGHT')
obs_qty_names(60) = obs_qty_type(QTY_INFRARED_RADIANCE, 'QTY_INFRARED_RADIANCE')
obs_qty_names(61) = obs_qty_type(QTY_INFRARED_BRIGHT_TEMP, 'QTY_INFRARED_BRIGHT_TEMP')
obs_qty_names(62) = obs_qty_type(QTY_LANDMASK, 'QTY_LANDMASK')
obs_qty_names(63) = obs_qty_type(QTY_EDGE_NORMAL_SPEED, 'QTY_EDGE_NORMAL_SPEED')
obs_qty_names(64) = obs_qty_type(QTY_CLW_PATH, 'QTY_CLW_PATH')
obs_qty_names(65) = obs_qty_type(QTY_WIND_TURBINE_POWER, 'QTY_WIND_TURBINE_POWER')
obs_qty_names(66) = obs_qty_type(QTY_2M_SPECIFIC_HUMIDITY, 'QTY_2M_SPECIFIC_HUMIDITY')
obs_qty_names(67) = obs_qty_type(QTY_2M_TEMPERATURE, 'QTY_2M_TEMPERATURE')
obs_qty_names(68) = obs_qty_type(QTY_10M_U_WIND_COMPONENT, 'QTY_10M_U_WIND_COMPONENT')
obs_qty_names(69) = obs_qty_type(QTY_10M_V_WIND_COMPONENT, 'QTY_10M_V_WIND_COMPONENT')
obs_qty_names(70) = obs_qty_type(QTY_SKIN_TEMPERATURE, 'QTY_SKIN_TEMPERATURE')
obs_qty_names(71) = obs_qty_type(QTY_NADIR_RADIANCE, 'QTY_NADIR_RADIANCE')
obs_qty_names(72) = obs_qty_type(QTY_TRACER_1_MIXING_RATIO, 'QTY_TRACER_1_MIXING_RATIO')
obs_qty_names(73) = obs_qty_type(QTY_TRACER_2_MIXING_RATIO, 'QTY_TRACER_2_MIXING_RATIO')
obs_qty_names(74) = obs_qty_type(QTY_SOIL_TEMPERATURE, 'QTY_SOIL_TEMPERATURE')
obs_qty_names(75) = obs_qty_type(QTY_SOIL_LIQUID_WATER, 'QTY_SOIL_LIQUID_WATER')
obs_qty_names(76) = obs_qty_type(QTY_VERTICAL_VORTICITY, 'QTY_VERTICAL_VORTICITY')
obs_qty_names(77) = obs_qty_type(QTY_SURFACE_ALBEDO, 'QTY_SURFACE_ALBEDO')
obs_qty_names(78) = obs_qty_type(QTY_SURFACE_EMISSIVITY, 'QTY_SURFACE_EMISSIVITY')
obs_qty_names(79) = obs_qty_type(QTY_DUST_OPACITY_7MB, 'QTY_DUST_OPACITY_7MB')
obs_qty_names(80) = obs_qty_type(QTY_THC, 'QTY_THC')
obs_qty_names(81) = obs_qty_type(QTY_VORTEX_LON, 'QTY_VORTEX_LON')
obs_qty_names(82) = obs_qty_type(QTY_VORTEX_LAT, 'QTY_VORTEX_LAT')
obs_qty_names(83) = obs_qty_type(QTY_VORTEX_PMIN, 'QTY_VORTEX_PMIN')
obs_qty_names(84) = obs_qty_type(QTY_VORTEX_WMAX, 'QTY_VORTEX_WMAX')
obs_qty_names(85) = obs_qty_type(QTY_EXNER_FUNCTION, 'QTY_EXNER_FUNCTION')
obs_qty_names(86) = obs_qty_type(QTY_TURBULENT_KINETIC_ENERGY, 'QTY_TURBULENT_KINETIC_ENERGY')
obs_qty_names(87) = obs_qty_type(QTY_TOTAL_PRECIPITABLE_WATER, 'QTY_TOTAL_PRECIPITABLE_WATER')
obs_qty_names(88) = obs_qty_type(QTY_VERTLEVEL, 'QTY_VERTLEVEL')
obs_qty_names(89) = obs_qty_type(QTY_MICROWAVE_BRIGHT_TEMP, 'QTY_MICROWAVE_BRIGHT_TEMP')
obs_qty_names(90) = obs_qty_type(QTY_INTEGRATED_SULFATE, 'QTY_INTEGRATED_SULFATE')
obs_qty_names(91) = obs_qty_type(QTY_INTEGRATED_DUST, 'QTY_INTEGRATED_DUST')
obs_qty_names(92) = obs_qty_type(QTY_INTEGRATED_SMOKE, 'QTY_INTEGRATED_SMOKE')
obs_qty_names(93) = obs_qty_type(QTY_INTEGRATED_SEASALT, 'QTY_INTEGRATED_SEASALT')
obs_qty_names(94) = obs_qty_type(QTY_INTEGRATED_AOD, 'QTY_INTEGRATED_AOD')
obs_qty_names(95) = obs_qty_type(QTY_SO2, 'QTY_SO2')
obs_qty_names(96) = obs_qty_type(QTY_SULFATE, 'QTY_SULFATE')
obs_qty_names(97) = obs_qty_type(QTY_DUST, 'QTY_DUST')
obs_qty_names(98) = obs_qty_type(QTY_SMOKE, 'QTY_SMOKE')
obs_qty_names(99) = obs_qty_type(QTY_SEASALT, 'QTY_SEASALT')
obs_qty_names(100) = obs_qty_type(QTY_HAIL_MIXING_RATIO, 'QTY_HAIL_MIXING_RATIO')
obs_qty_names(101) = obs_qty_type(QTY_HAIL_NUMBER_CONCENTR, 'QTY_HAIL_NUMBER_CONCENTR')
obs_qty_names(102) = obs_qty_type(QTY_GRAUPEL_VOLUME, 'QTY_GRAUPEL_VOLUME')
obs_qty_names(103) = obs_qty_type(QTY_HAIL_VOLUME, 'QTY_HAIL_VOLUME')
obs_qty_names(104) = obs_qty_type(QTY_DIFFERENTIAL_REFLECTIVITY, 'QTY_DIFFERENTIAL_REFLECTIVITY')
obs_qty_names(105) = obs_qty_type(QTY_SPECIFIC_DIFFERENTIAL_PHASE, 'QTY_SPECIFIC_DIFFERENTIAL_PHASE')
obs_qty_names(106) = obs_qty_type(QTY_FLASH_RATE_2D, 'QTY_FLASH_RATE_2D')

obs_qty_names(107) = obs_qty_type(QTY_SNOW_THICKNESS        ,'QTY_SNOW_THICKNESS')
obs_qty_names(108) = obs_qty_type(QTY_SNOW_WATER            ,'QTY_SNOW_WATER')
obs_qty_names(109) = obs_qty_type(QTY_SNOWCOVER_FRAC        ,'QTY_SNOWCOVER_FRAC')
obs_qty_names(110) = obs_qty_type(QTY_LIQUID_WATER          ,'QTY_LIQUID_WATER')
obs_qty_names(111) = obs_qty_type(QTY_ICE                   ,'QTY_ICE')
obs_qty_names(112) = obs_qty_type(QTY_CARBON                ,'QTY_CARBON')
obs_qty_names(113) = obs_qty_type(QTY_SOIL_CARBON           ,'QTY_SOIL_CARBON')
obs_qty_names(114) = obs_qty_type(QTY_ROOT_CARBON           ,'QTY_ROOT_CARBON')
obs_qty_names(115) = obs_qty_type(QTY_STEM_CARBON           ,'QTY_STEM_CARBON')
obs_qty_names(116) = obs_qty_type(QTY_LEAF_CARBON           ,'QTY_LEAF_CARBON')
obs_qty_names(117) = obs_qty_type(QTY_LEAF_AREA_INDEX       ,'QTY_LEAF_AREA_INDEX')
obs_qty_names(118) = obs_qty_type(QTY_NET_CARBON_FLUX       ,'QTY_NET_CARBON_FLUX')
obs_qty_names(119) = obs_qty_type(QTY_LATENT_HEAT_FLUX      ,'QTY_LATENT_HEAT_FLUX')
obs_qty_names(120) = obs_qty_type(QTY_SENSIBLE_HEAT_FLUX    ,'QTY_SENSIBLE_HEAT_FLUX')
obs_qty_names(121) = obs_qty_type(QTY_RADIATION             ,'QTY_RADIATION')
obs_qty_names(122) = obs_qty_type(QTY_NET_CARBON_PRODUCTION ,'QTY_NET_CARBON_PRODUCTION')
obs_qty_names(123) = obs_qty_type(QTY_NITROGEN              ,'QTY_NITROGEN')
obs_qty_names(124) = obs_qty_type(QTY_SOIL_NITROGEN         ,'QTY_SOIL_NITROGEN')
obs_qty_names(125) = obs_qty_type(QTY_ROOT_NITROGEN         ,'QTY_ROOT_NITROGEN')
obs_qty_names(126) = obs_qty_type(QTY_STEM_NITROGEN         ,'QTY_STEM_NITROGEN')
obs_qty_names(127) = obs_qty_type(QTY_LEAF_NITROGEN         ,'QTY_LEAF_NITROGEN')
obs_qty_names(128) = obs_qty_type(QTY_WATER_TABLE_DEPTH     ,'QTY_WATER_TABLE_DEPTH')
obs_qty_names(129) = obs_qty_type(QTY_FPAR                  ,'QTY_FPAR')
obs_qty_names(130) = obs_qty_type(QTY_TOTAL_WATER_STORAGE   ,'QTY_TOTAL_WATER_STORAGE')

obs_qty_names(140) = obs_qty_type(QTY_NEUTRON_INTENSITY     ,'QTY_NEUTRON_INTENSITY')
obs_qty_names(141) = obs_qty_type(QTY_CANOPY_WATER          ,'QTY_CANOPY_WATER')
obs_qty_names(142) = obs_qty_type(QTY_GROUND_HEAT_FLUX      ,'QTY_GROUND_HEAT_FLUX')
obs_qty_names(143) = obs_qty_type(QTY_VERTICAL_TEC          ,'QTY_VERTICAL_TEC')
obs_qty_names(144) = obs_qty_type(QTY_O_N2_COLUMN_DENSITY_RATIO, 'QTY_O_N2_COLUMN_DENSITY_RATIO')

obs_qty_names(151) = obs_qty_type(QTY_O3,             'QTY_O3')
obs_qty_names(153) = obs_qty_type(QTY_CO,             'QTY_CO')
obs_qty_names(155) = obs_qty_type(QTY_NO,             'QTY_NO')
obs_qty_names(156) = obs_qty_type(QTY_NO2,            'QTY_NO2')

obs_qty_names(161) = obs_qty_type(QTY_CO01,           'QTY_CO01')
obs_qty_names(162) = obs_qty_type(QTY_CO02,           'QTY_CO02')
obs_qty_names(163) = obs_qty_type(QTY_CO03,           'QTY_CO03')

obs_qty_names(170) = obs_qty_type(QTY_SFCO,           'QTY_SFCO')
obs_qty_names(171) = obs_qty_type(QTY_SFCO01,         'QTY_SFCO01')
obs_qty_names(172) = obs_qty_type(QTY_SFCO02,         'QTY_SFCO02')
obs_qty_names(173) = obs_qty_type(QTY_SFCO03,         'QTY_SFCO03')
obs_qty_names(174) = obs_qty_type(QTY_STATE_VAR_POWER,'QTY_STATE_VAR_POWER')

obs_qty_names(200) = obs_qty_type(QTY_AOD,            'QTY_AOD')
obs_qty_names(201) = obs_qty_type(QTY_CB1,            'QTY_CB1')
obs_qty_names(202) = obs_qty_type(QTY_CB2,            'QTY_CB2')
obs_qty_names(203) = obs_qty_type(QTY_OC1,            'QTY_OC1')
obs_qty_names(204) = obs_qty_type(QTY_OC2,            'QTY_OC2')
obs_qty_names(205) = obs_qty_type(QTY_CB1,            'QTY_CB102')
obs_qty_names(206) = obs_qty_type(QTY_CB2,            'QTY_CB202')
obs_qty_names(207) = obs_qty_type(QTY_OC1,            'QTY_OC102')
obs_qty_names(208) = obs_qty_type(QTY_OC2,            'QTY_OC202')

obs_qty_names(221) = obs_qty_type(QTY_SFCB1,          'QTY_SFCB1')
obs_qty_names(222) = obs_qty_type(QTY_SFCB2,          'QTY_SFCB2')
obs_qty_names(223) = obs_qty_type(QTY_SFOC1,          'QTY_SFOC1')
obs_qty_names(224) = obs_qty_type(QTY_SFOC2,          'QTY_SFOC2')
obs_qty_names(225) = obs_qty_type(QTY_SFCB1,          'QTY_SFCB102')
obs_qty_names(226) = obs_qty_type(QTY_SFCB2,          'QTY_SFCB202')
obs_qty_names(227) = obs_qty_type(QTY_SFOC1,          'QTY_SFOC102')
obs_qty_names(228) = obs_qty_type(QTY_SFOC2,          'QTY_SFOC202')

obs_qty_names(247) = obs_qty_type(QTY_CO2,            'QTY_CO2')
obs_qty_names(248) = obs_qty_type(QTY_NH3,            'QTY_NH3')
obs_qty_names(249) = obs_qty_type(QTY_CH4,            'QTY_CH4')

obs_qty_names(251) = obs_qty_type(QTY_TEMPERATURE_ELECTRON  ,'QTY_TEMPERATURE_ELECTRON')
obs_qty_names(252) = obs_qty_type(QTY_TEMPERATURE_ION       ,'QTY_TEMPERATURE_ION')
obs_qty_names(253) = obs_qty_type(QTY_DENSITY_NEUTRAL_O3P   ,'QTY_DENSITY_NEUTRAL_O3P')
obs_qty_names(254) = obs_qty_type(QTY_DENSITY_NEUTRAL_O2    ,'QTY_DENSITY_NEUTRAL_O2')
obs_qty_names(255) = obs_qty_type(QTY_DENSITY_NEUTRAL_N2    ,'QTY_DENSITY_NEUTRAL_N2')
obs_qty_names(256) = obs_qty_type(QTY_DENSITY_NEUTRAL_N4S   ,'QTY_DENSITY_NEUTRAL_N4S')
obs_qty_names(257) = obs_qty_type(QTY_DENSITY_NEUTRAL_NO    ,'QTY_DENSITY_NEUTRAL_NO')
obs_qty_names(258) = obs_qty_type(QTY_DENSITY_NEUTRAL_N2D   ,'QTY_DENSITY_NEUTRAL_N2D')
obs_qty_names(259) = obs_qty_type(QTY_DENSITY_NEUTRAL_N2P   ,'QTY_DENSITY_NEUTRAL_N2P')
obs_qty_names(260) = obs_qty_type(QTY_DENSITY_NEUTRAL_H     ,'QTY_DENSITY_NEUTRAL_H')
obs_qty_names(261) = obs_qty_type(QTY_DENSITY_NEUTRAL_HE    ,'QTY_DENSITY_NEUTRAL_HE')
obs_qty_names(262) = obs_qty_type(QTY_DENSITY_NEUTRAL_CO2   ,'QTY_DENSITY_NEUTRAL_CO2')
obs_qty_names(263) = obs_qty_type(QTY_DENSITY_NEUTRAL_O1D   ,'QTY_DENSITY_NEUTRAL_O1D')
obs_qty_names(264) = obs_qty_type(QTY_DENSITY_ION_O4SP      ,'QTY_DENSITY_ION_O4SP')
obs_qty_names(265) = obs_qty_type(QTY_DENSITY_ION_O2P       ,'QTY_DENSITY_ION_O2P')
obs_qty_names(266) = obs_qty_type(QTY_DENSITY_ION_N2P       ,'QTY_DENSITY_ION_N2P')
obs_qty_names(267) = obs_qty_type(QTY_DENSITY_ION_NP        ,'QTY_DENSITY_ION_NP')
obs_qty_names(268) = obs_qty_type(QTY_DENSITY_ION_NOP       ,'QTY_DENSITY_ION_NOP')
obs_qty_names(269) = obs_qty_type(QTY_DENSITY_ION_O2DP      ,'QTY_DENSITY_ION_O2DP')
obs_qty_names(270) = obs_qty_type(QTY_DENSITY_ION_O2PP      ,'QTY_DENSITY_ION_O2PP')
obs_qty_names(271) = obs_qty_type(QTY_DENSITY_ION_HP        ,'QTY_DENSITY_ION_HP')
obs_qty_names(272) = obs_qty_type(QTY_DENSITY_ION_HEP       ,'QTY_DENSITY_ION_HEP')
obs_qty_names(273) = obs_qty_type(QTY_DENSITY_ION_E         ,'QTY_DENSITY_ION_E')
obs_qty_names(274) = obs_qty_type(QTY_VELOCITY_U            ,'QTY_VELOCITY_U')
obs_qty_names(275) = obs_qty_type(QTY_VELOCITY_V            ,'QTY_VELOCITY_V')
obs_qty_names(276) = obs_qty_type(QTY_VELOCITY_W            ,'QTY_VELOCITY_W')
obs_qty_names(277) = obs_qty_type(QTY_VELOCITY_U_ION        ,'QTY_VELOCITY_U_ION')
obs_qty_names(278) = obs_qty_type(QTY_VELOCITY_V_ION        ,'QTY_VELOCITY_V_ION')
obs_qty_names(279) = obs_qty_type(QTY_VELOCITY_W_ION        ,'QTY_VELOCITY_W_ION')
obs_qty_names(280) = obs_qty_type(QTY_VELOCITY_VERTICAL_O3P ,'QTY_VELOCITY_VERTICAL_O3P')
obs_qty_names(281) = obs_qty_type(QTY_VELOCITY_VERTICAL_O2  ,'QTY_VELOCITY_VERTICAL_O2')
obs_qty_names(282) = obs_qty_type(QTY_VELOCITY_VERTICAL_N2  ,'QTY_VELOCITY_VERTICAL_N2')
obs_qty_names(283) = obs_qty_type(QTY_VELOCITY_VERTICAL_N4S ,'QTY_VELOCITY_VERTICAL_N4S')
obs_qty_names(284) = obs_qty_type(QTY_VELOCITY_VERTICAL_NO  ,'QTY_VELOCITY_VERTICAL_NO')
obs_qty_names(285) = obs_qty_type(QTY_GND_GPS_VTEC          ,'QTY_GND_GPS_VTEC')
obs_qty_names(286) = obs_qty_type(QTY_DENSITY_ION_OP        ,'QTY_DENSITY_ION_OP')

obs_qty_names(300) = obs_qty_type(QTY_BRIGHTNESS_TEMPERATURE,'QTY_BRIGHTNESS_TEMPERATURE')
obs_qty_names(301) = obs_qty_type(QTY_VEGETATION_TEMPERATURE,'QTY_VEGETATION_TEMPERATURE')
obs_qty_names(302) = obs_qty_type(QTY_CANOPY_HEIGHT         ,'QTY_CANOPY_HEIGHT')
obs_qty_names(303) = obs_qty_type(QTY_FPAR_DIRECT           ,'QTY_FPAR_DIRECT')
obs_qty_names(304) = obs_qty_type(QTY_FPAR_DIFFUSE          ,'QTY_FPAR_DIFFUSE')
obs_qty_names(305) = obs_qty_type(QTY_FPAR_SUNLIT_DIRECT    ,'QTY_FPAR_SUNLIT_DIRECT')
obs_qty_names(306) = obs_qty_type(QTY_FPAR_SUNLIT_DIFFUSE   ,'QTY_FPAR_SUNLIT_DIFFUSE')
obs_qty_names(307) = obs_qty_type(QTY_FPAR_SHADED_DIRECT    ,'QTY_FPAR_SHADED_DIRECT')
obs_qty_names(308) = obs_qty_type(QTY_FPAR_SHADED_DIFFUSE   ,'QTY_FPAR_SHADED_DIFFUSE')
obs_qty_names(309) = obs_qty_type(QTY_FPSN                  ,'QTY_FPSN')
obs_qty_names(310) = obs_qty_type(QTY_FSIF                  ,'QTY_FSIF')

obs_qty_names(311) = obs_qty_type(QTY_SEAICE_AGREG_CONCENTR ,'QTY_SEAICE_AGREG_CONCENTR')
obs_qty_names(312) = obs_qty_type(QTY_SEAICE_AGREG_VOLUME   ,'QTY_SEAICE_AGREG_VOLUME')
obs_qty_names(313) = obs_qty_type(QTY_SEAICE_AGREG_SNOWVOLUME,'QTY_SEAICE_AGREG_SNOWVOLUME')
obs_qty_names(314) = obs_qty_type(QTY_SEAICE_AGREG_THICKNESS,'QTY_SEAICE_AGREG_THICKNESS')
obs_qty_names(315) = obs_qty_type(QTY_SEAICE_AGREG_SNOWDEPTH,'QTY_SEAICE_AGREG_SNOWDEPTH')
obs_qty_names(316) = obs_qty_type(QTY_U_SEAICE_COMPONENT    ,'QTY_U_SEAICE_COMPONENT')
obs_qty_names(317) = obs_qty_type(QTY_V_SEAICE_COMPONENT    ,'QTY_V_SEAICE_COMPONENT')
obs_qty_names(318) = obs_qty_type(QTY_SEAICE_ALBEDODIRVIZ   ,'QTY_SEAICE_ALBEDODIRVIZ')
obs_qty_names(319) = obs_qty_type(QTY_SEAICE_ALBEDODIRNIR   ,'QTY_SEAICE_ALBEDODIRNIR')
obs_qty_names(320) = obs_qty_type(QTY_SEAICE_ALBEDOINDVIZ   ,'QTY_SEAICE_ALBEDOINDVIZ')
obs_qty_names(321) = obs_qty_type(QTY_SEAICE_ALBEDOINDNIR   ,'QTY_SEAICE_ALBEDOINDNIR')
obs_qty_names(322) = obs_qty_type(QTY_SEAICE_CONCENTR       ,'QTY_SEAICE_CONCENTR')
obs_qty_names(323) = obs_qty_type(QTY_SEAICE_VOLUME         ,'QTY_SEAICE_VOLUME')
obs_qty_names(324) = obs_qty_type(QTY_SEAICE_SNOWVOLUME     ,'QTY_SEAICE_SNOWVOLUME')
obs_qty_names(325) = obs_qty_type(QTY_SEAICE_SURFACETEMP    ,'QTY_SEAICE_SURFACETEMP')
obs_qty_names(326) = obs_qty_type(QTY_SEAICE_FIRSTYEARAREA  ,'QTY_SEAICE_FIRSTYEARAREA')
obs_qty_names(327) = obs_qty_type(QTY_SEAICE_ICEAGE         ,'QTY_SEAICE_ICEAGE')
obs_qty_names(328) = obs_qty_type(QTY_SEAICE_LEVELAREA      ,'QTY_SEAICE_LEVELAREA')
obs_qty_names(329) = obs_qty_type(QTY_SEAICE_LEVELVOLUME    ,'QTY_SEAICE_LEVELVOLUME')
obs_qty_names(330) = obs_qty_type(QTY_SEAICE_MELTPONDAREA   ,'QTY_SEAICE_MELTPONDAREA')
obs_qty_names(331) = obs_qty_type(QTY_SEAICE_MELTPONDDEPTH  ,'QTY_SEAICE_MELTPONDDEPTH')
obs_qty_names(332) = obs_qty_type(QTY_SEAICE_MELTPONDLID    ,'QTY_SEAICE_MELTPONDLID')
obs_qty_names(333) = obs_qty_type(QTY_SEAICE_MELTPONDSNOW   ,'QTY_SEAICE_MELTPONDSNOW')
obs_qty_names(334) = obs_qty_type(QTY_SEAICE_SALINITY001    ,'QTY_SEAICE_SALINITY001')
obs_qty_names(335) = obs_qty_type(QTY_SEAICE_SALINITY002    ,'QTY_SEAICE_SALINITY002')
obs_qty_names(336) = obs_qty_type(QTY_SEAICE_SALINITY003    ,'QTY_SEAICE_SALINITY003')
obs_qty_names(337) = obs_qty_type(QTY_SEAICE_SALINITY004    ,'QTY_SEAICE_SALINITY004')
obs_qty_names(338) = obs_qty_type(QTY_SEAICE_SALINITY005    ,'QTY_SEAICE_SALINITY005')
obs_qty_names(339) = obs_qty_type(QTY_SEAICE_SALINITY006    ,'QTY_SEAICE_SALINITY006')
obs_qty_names(340) = obs_qty_type(QTY_SEAICE_SALINITY007    ,'QTY_SEAICE_SALINITY007')
obs_qty_names(341) = obs_qty_type(QTY_SEAICE_SALINITY008    ,'QTY_SEAICE_SALINITY008')
obs_qty_names(342) = obs_qty_type(QTY_SEAICE_ICEENTHALPY001 ,'QTY_SEAICE_ICEENTHALPY001')
obs_qty_names(343) = obs_qty_type(QTY_SEAICE_ICEENTHALPY002 ,'QTY_SEAICE_ICEENTHALPY002')
obs_qty_names(344) = obs_qty_type(QTY_SEAICE_ICEENTHALPY003 ,'QTY_SEAICE_ICEENTHALPY003')
obs_qty_names(345) = obs_qty_type(QTY_SEAICE_ICEENTHALPY004 ,'QTY_SEAICE_ICEENTHALPY004')
obs_qty_names(346) = obs_qty_type(QTY_SEAICE_ICEENTHALPY005 ,'QTY_SEAICE_ICEENTHALPY005')
obs_qty_names(347) = obs_qty_type(QTY_SEAICE_ICEENTHALPY006 ,'QTY_SEAICE_ICEENTHALPY006')
obs_qty_names(348) = obs_qty_type(QTY_SEAICE_ICEENTHALPY007 ,'QTY_SEAICE_ICEENTHALPY007')
obs_qty_names(349) = obs_qty_type(QTY_SEAICE_ICEENTHALPY008 ,'QTY_SEAICE_ICEENTHALPY008')
obs_qty_names(350) = obs_qty_type(QTY_SEAICE_SNOWENTHALPY001,'QTY_SEAICE_SNOWENTHALPY001')
obs_qty_names(351) = obs_qty_type(QTY_SEAICE_SNOWENTHALPY002,'QTY_SEAICE_SNOWENTHALPY002')
obs_qty_names(352) = obs_qty_type(QTY_SEAICE_SNOWENTHALPY003,'QTY_SEAICE_SNOWENTHALPY003')
obs_qty_names(353) = obs_qty_type(QTY_SOM_TEMPERATURE,       'QTY_SOM_TEMPERATURE')
obs_qty_names(354) = obs_qty_type(QTY_SEAICE_FY,             'QTY_SEAICE_FY')
obs_qty_names(355) = obs_qty_type(QTY_SEAICE_AGREG_FY,       'QTY_SEAICE_AGREG_FY')
obs_qty_names(356) = obs_qty_type(QTY_SEAICE_AGREG_SURFACETEMP,'QTY_SEAICE_AGREG_SURFACETEMP')

obs_qty_names(360) = obs_qty_type(QTY_SEA_SURFACE_ANOMALY,   'QTY_SEA_SURFACE_ANOMALY')
obs_qty_names(361) = obs_qty_type(QTY_LARGE_SCALE_STATE,     'QTY_LARGE_SCALE_STATE')
obs_qty_names(362) = obs_qty_type(QTY_SMALL_SCALE_STATE,     'QTY_SMALL_SCALE_STATE')
obs_qty_names(363) = obs_qty_type(QTY_CWP_PATH,              'QTY_CWP_PATH')
obs_qty_names(364) = obs_qty_type(QTY_CWP_PATH_ZERO,         'QTY_CWP_PATH_ZERO')
...
!>@todo FIXME candidate for sorted list and binary search?
