...
stagger = grid_stagger%qty_stagger(obs_quantity)
...
if (debug_level > 0) then
   surface_elevation = phis(lon_index, lat_index) / gravity
   print *, 'surface elevation direct from phis: ', surface_elevation
endif
!> this routine does the right stagger as well.
call get_quad_corners(1, lon_index, lat_index, qty, surface_elevation, status1)
