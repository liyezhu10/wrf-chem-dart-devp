...
#export EMISSIONS_DIR=chem_static_100km_p30_uncor
export EMISSIONS_DIR=chem_static_100km_p30_corr
#export EMISSIONS_DIR=chem_static_100km_p40_corr
#export WPB_RC_DIR=wpb_rc_chem_100km_p10_uncor
#export WPB_RC_DIR=wpb_rc_chem_100km_p40_uncor
#export WPB_RC_DIR=wpb_rc_chem_100km_p20_corr
#export WPB_RC_DIR=wpb_rc_chem_100km_p10_corr_n95
export WPB_RC_DIR=wpb_rc_chem_100km_p10_corr
#export WPB_RC_DIR=wpb_rc_chem_100km_p10_corr_n40
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RAWR_NO_ROT_SUPR_filt
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_QOR_NO_ROT_SUPR_filt
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_QOR_NO_SCALE_SUPR_filt
#export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_CPSR_NO_SCALE_SUPR_filt
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/XXXnIAS_Exp_2_MgDA_20M_100km_COnXX_RETR_QOR_NO_SCALE_SUPR
mkdir -p ${RUN_DIR}
#
...
#
# Copy wrfinput files to parent directory because
            let IMEM=1
            while [[ ${IMEM} -le ${NUM_MEMBERS} ]]; do
               export KMEM=${IMEM}
               export CMEM=e${IMEM}
