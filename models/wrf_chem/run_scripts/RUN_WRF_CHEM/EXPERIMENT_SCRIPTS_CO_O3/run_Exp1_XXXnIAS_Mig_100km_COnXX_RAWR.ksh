...
#export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_F50_NO_ROT_SUPR_filt
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/XXXnIAS_Exp_1_MgDA_20M_100km_COnXX_RAWR_NO_ROT_SUPR
mkdir -p ${RUN_DIR}
#
