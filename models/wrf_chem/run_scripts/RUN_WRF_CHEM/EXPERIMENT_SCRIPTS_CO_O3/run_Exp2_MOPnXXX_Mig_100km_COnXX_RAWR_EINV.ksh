...
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RAWR_F50_NO_ROT_SUPR_filt
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RAWR_NO_ROT_SUPR_filt
...
export DART_VER=DART_CHEM_MY_BRANCH_EINV
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnXXX_Exp_2_MgDA_20M_100km_COnXX_RAWR_NO_ROT_EINV_SUPR
mkdir -p ${RUN_DIR}
#
...
# &assim_tools_nml
   ...
   export NL_SPECIAL_LOCALIZATION_OBS_TYPES="'MOPITT_CO_RETRIEVAL','IASI_CO_RETRIEVAL','IASI_O3_RETRIEVAL'"
...
# &model_nml
   ...
   export NL_WRF_STATE_VARIABLES="'U',     'KIND_U_WIND_COMPONENT',     'TYPE_U',  'UPDATE','999',
                                  ...
                                  'E_CO'  ,'KIND_CO',                   'TYPE_E_CO', 'UPDATE','999',
                                  'E_NO'  ,'KIND_NO',                   'TYPE_E_NO', 'UPDATE','999'"
   ...
   export NL_CONC_STATE_VARIABLES="'U',     'KIND_U_WIND_COMPONENT',     'TYPE_U',  'UPDATE','999',
     ...
     export NL_EMISS_STATE_VARIABLES="'E_CO'  ,'KIND_CO',                   'TYPE_E_CO', 'UPDATE','999',
                                      'E_NO'  ,'KIND_NO',                   'TYPE_E_NO', 'UPDATE','999'"
...
# One WRFCHEM file as template
               if [[ ${LL_DATE} -eq ${L_DATE} ]]; then
                  cp wrfchemi_d${DOMAIN}_$L_FILE_DATE} ${CENTRALDIR}/wrfinput_d${DOMAIN}
               fi
               export LL_DATE=`echo ${LL_DATE} +1h | ./advance_time` 
            done
#
