...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnXXX_Exp_1_MgDA_20M_100km_COnXX_RETR_NO_ROT_SUPR
mkdir -p ${RUN_DIR}
#
...
#                                      'IASI_CO_RETRIEVAL',
#                                      'IASI_O3_RETRIEVAL'"
   export NL_EVALUATE_THESE_OBS_TYPES="'MOPITT_CO_RETRIEVAL','IASI_CO_RETRIEVAL'"
#
