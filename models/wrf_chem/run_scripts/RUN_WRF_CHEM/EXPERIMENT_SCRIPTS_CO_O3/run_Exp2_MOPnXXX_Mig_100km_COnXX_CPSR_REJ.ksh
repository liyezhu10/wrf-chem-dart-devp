...
#export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_QOR_SCALE_SUPR_filt
...
#export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_CPSR_SCALE_RJ3_SUPR_filt
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_CPSR_SCALE_BLOC_SUPR_filt
#
#  CPSR_SCALE_BLOC has vertical localization
#
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnXXX_Exp_2_MgDA_20M_100km_COnXX_RETR_CPSR_SCALE_BLOC_SUPR
mkdir -p ${RUN_DIR}
#
