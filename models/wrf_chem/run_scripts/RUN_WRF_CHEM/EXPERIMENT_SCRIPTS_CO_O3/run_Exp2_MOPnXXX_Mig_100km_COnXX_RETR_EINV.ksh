...
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_NO_ROT_SUPR_filt
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnXXX_Exp_2_MgDA_20M_100km_COnXX_RETR_NO_ROT_EINV_SUPR
mkdir -p ${RUN_DIR}
#
