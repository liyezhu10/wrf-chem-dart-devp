...
#export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_ME_NO_ROT_SUPR_filt
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_NO_ROT_RJ3_SUPR_filt
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnXXX_Exp_2_MgDA_20M_100km_COnXX_RETR_NO_ROT_RJ3_SUPR
mkdir -p ${RUN_DIR}
#
...
#   export NL_VERT_NORMALIZATION_SCALE_HEIGHT=8.0
#   export NL_VERT_NORMALIZATION_SCALE_HEIGHT=4.0
#   export NL_VERT_NORMALIZATION_SCALE_HEIGHT=2.0
   export NL_VERT_NORMALIZATION_SCALE_HEIGHT=1.5
#   export NL_VERT_NORMALIZATION_SCALE_HEIGHT=1.0
#
