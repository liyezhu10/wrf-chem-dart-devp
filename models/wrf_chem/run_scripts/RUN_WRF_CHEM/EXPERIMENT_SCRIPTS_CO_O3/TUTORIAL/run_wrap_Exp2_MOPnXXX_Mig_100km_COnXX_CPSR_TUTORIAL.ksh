...
export W_START_DATE=2008060618
export W_END_DATE=2008060618
export W_PROJ_NUMBER_ASP=NASP0006
export W_EXPERIMENT=Ex2_MOPnXXX_Mg_100km_CPSR_Tutorial
export W_NL_LOCALIZATION_CUTOFF=.2,.2,.2
export W_NL_LOCALIZATION_CUTOFF=.05,.05,.05
export W_NL_LOCALIZATION_CUTOFF=.1,.1,.1
export W_NL_LOCALIZATION_CUTOFF=.025,.025,.025
export W_OUTPUT_NAME=DART_TEST_AVE/MOPnXXX_Exp_2_MgDA_20M_100km_COnXX_RETR_CPSR_SCALE_SUPR_TUTORIAL
...
export W_RUN_SCRIPT_DIR=${W_DART_DIR}/models/wrf_chem/run_scripts/RUN_WRF_CHEM/EXPERIMENT_SCRIPTS_CO_O3/TUTORIAL
#
# DO NOT CHANGE ANYTHING BELOW HERE FOR TUTORIAL
#
...
export W_PROJ_NUMBER_ACD=${W_PROJ_NUMBER_ASP}
export W_PROJ_NUMBER_NSC=${W_PROJ_NUMBER_ASP}
#   
...
cp ${W_RUN_SCRIPT_DIR}/run_Exp2_MOPnXXX_Mig_100km_COnXX_CPSR_TUTORIAL.ksh run_script.ksh
