...
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_CPSR_SCALE_RJ0_SUPR_filt
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_CPSR_SCALE_SUPR_SINGLE_CLUSTER_filt
export OBS_SEQ_DIR=obs_MOPITT_CO_RETR_CPSR_SCALE_SUPR_SINGLE_CLUSTER
...
export RUN_WRFCHEM=false
export RUN_ARCHIVE=false
#
...
export RUN_DIR=${SCRATCH_DIR}/${W_OUTPUT_NAME}
mkdir -p ${RUN_DIR}
#
...
# &assim_tools_nml
   ...
   export NL_SPECIAL_LOCALIZATION_CUTOFFS=${W_NL_LOCALIZATION_CUTOFF}
