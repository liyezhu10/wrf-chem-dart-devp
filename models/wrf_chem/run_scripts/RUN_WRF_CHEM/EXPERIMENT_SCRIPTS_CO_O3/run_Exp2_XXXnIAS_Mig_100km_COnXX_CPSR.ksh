...
#export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_F25_CPSR_SCALE_SUPR_filt
#export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_F10_CPSR_SCALE_SUPR_filt
export OBS_SEQ_DIR=obs_MOPnIAS_CO_O3_RETR_F05_CPSR_SCALE_SUPR_filt
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/XXXnIAS_Exp_2_MgDA_20M_100km_COnXX_RAWR_F05_CPSR_SCALE_SUPR
mkdir -p ${RUN_DIR}
#
