...
export W_START_DATE=2008060312
...
export W_EXPERIMENT=Ex2_MOPnXXX_COnXX_CPSR
...
export W_PROJ_NUMBER=${W_PROJ_NUMBER_ACD}
#   
# Define directories
...
export W_RUN_SCRIPT_DIR=${W_DART_DIR}/models/wrf_chem/run_scripts/RUN_WRF_CHEM/EXPERIMENT_SCRIPTS_CO_O3
...
cp ${W_RUN_SCRIPT_DIR}/run_Exp2_MOPnXXX_Mig_100km_COnXX_CPSR.ksh run_script.ksh
