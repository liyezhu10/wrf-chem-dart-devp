...
# APM +++ temporary reset to false for testing filter
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnXXX_Exp_2_MgDA_20M_100km_COnXX_RETR_CPSR_SCALE_RJ3LOC_p50_SUPR
mkdir -p ${RUN_DIR}
#
