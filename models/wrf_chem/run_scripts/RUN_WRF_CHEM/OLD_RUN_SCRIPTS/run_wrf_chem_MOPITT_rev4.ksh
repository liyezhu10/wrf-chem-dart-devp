...
export START_DATE=2008060218
export END_DATE=2008060218
...
export RUN_DIR=/glade/scratch/mizzi/DART_TEST_AVE/MOPITT_TEST
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE/MOPITT_TEST
...
#         if [[ ${CHEM_TYPE} == MOPITT_CO ]]; then export FILE=obs_seq.proc; fi
         if [[ ${CHEM_TYPE} == MOPITT_CO ]]; then export FILE=obs_seq_test.out; fi
         if ${USE_HSI}; then
