...
export START_DATE=2008061100
export END_DATE=2008061200
export FIRST_FILTER_DATE=2008060200
export DOMAIN=01
...
export TIME_LIMIT_WRFCHEM=0:58
export NUM_TASKS=32
...
export RUN_DIR=/glade/scratch/mizzi/DART_CHEM
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE
...
# Copy necessary executables from DART to $CENTRALDIR
   ...
   cp ${DART_DIR}/models/wrf/work/input.nml ${CENTRALDIR}/input.nml
   cp ${DART_DIR}/models/wrf/work/advance_time ${CENTRALDIR}/.
   cp ${DART_DIR}/models/wrf/work/pert_wrf_bc ${CENTRALDIR}/.
   cp ${DART_DIR}/models/wrf/work/update_wrf_bc ${CENTRALDIR}/.
   cp ${DART_DIR}/models/wrf/work/dart_to_wrf ${CENTRALDIR}/.
   cp ${DART_DIR}/models/wrf/work/wrf_to_dart ${CENTRALDIR}/.
   cp ${DART_DIR}/models/wrf/work/filter ${CENTRALDIR}/.
   cp ${DART_DIR}/models/wrf/work/restart_file_tool ${CENTRALDIR}/.
...
# &assim_tools_nml
   ...
   export NL_SPECIAL_LOCALIZATION_OBS_TYPES="'IASI_O3_RETRIEVAL'"
...
# Get the obs_seq.out file for current cycle
         export FILE=obs_seq.out
         if [[ ${OBS_DIR} == obs_IASI ]]; then export FILE=obs_seq_${L_DATE}.out; fi
         if ${USE_HSI}; then
