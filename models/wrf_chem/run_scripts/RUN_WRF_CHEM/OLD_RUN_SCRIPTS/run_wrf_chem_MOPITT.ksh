...
export START_DATE=2008060906
export END_DATE=2008061200
export END_DATE=2008061000
export FIRST_FILTER_DATE=2008060900
export CHEM_TYPE=NONE
export CHEM_TYPE=IASI_O3
export CHEM_TYPE=OMI_NO2
export CHEM_TYPE=MODIS_AOD
export CHEM_TYPE=MOPITT_CO
export DOMAIN=01
export NUM_MEMBERS=3
...
export WPB_RC_DIR=wpb_rc_gabi
export OBS_DIR=obs
if [[ ${CHEM_TYPE} == MOPITT_CO ]]; then export OBS_DIR=obs_MOPITT; fi
if [[ ${CHEM_TYPE} == IASI_O3 ]]; then export OBS_DIR=obs_IASI; fi
if [[ ${CHEM_TYPE} == MODIS_AOD ]]; then export OBS_DIR=obs_MODIS; fi
...
export RUN_DIR=/glade/scratch/mizzi/DART_TEST_AVE/MOPITT
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE/MOPITT
...
# &filter.nml
   ...
   export NL_INF_UPPER_BOUND_PRIOR=1000000.0
   export NL_INF_UPPER_BOUND_POST=1000000.0
...
# &model_nml
   ...
   export NL_WRF_STATE_VARIABLES="'U',     'KIND_U_WIND_COMPONENT',     'TYPE_U',  'UPDATE','999',
                              ...
                              'OC2',   'KIND_OC1',                  'TYPE_OC2',    'UPDATE','999',
                              'dms',   'KIND_DMS',                  'TYPE_DMS',    'UPDATE','999',
                              ...
                              'TAUAER1','KIND_TAUAER1',             'TYPE_TAUAER1','UPDATE','999',
                              'TAUAER2','KIND_TAUAER2',             'TYPE_TAUAER2','UPDATE','999',
                              'TAUAER3','KIND_TAUAER3',             'TYPE_TAUAER3','UPDATE','999',
                              'TAUAER4','KIND_TAUAER4',             'TYPE_TAUAER4','UPDATE','999',
                              'PM10',   'KIND_PM10',                'TYPE_PM10',   'UPDATE','999',
                              'PM2_5_DRY',   'KIND_PM25',           'TYPE_PM25',   'UPDATE','999'"
...
#
# &preprocess_nml
   export NL_INPUT_OBS_KIND_MOD_FILE="'/glade/p/work/mizzi/TRUNK/DART_DEVEL/obs_kind/DEFAULT_obs_kind_mod.F90'"
   export NL_OUTPUT_OBS_KIND_MOD_FILE="'/glade/p/work/mizzi/TRUNK/DART_DEVEL/obs_kind/obs_kind_mod.f90'"
   export NL_INPUT_OBS_DEF_MOD_FILE="'/glade/p/work/mizzi/TRUNK/DART_DEVEL/obs_kind/DEFAULT_obs_def_mod.F90'"
   export NL_OUTPUT_OBS_DEF_MOD_FILE="'/glade/p/work/mizzi/TRUNK/DART_DEVEL/obs_kind/obs_def_mod.f90'"
   export NL_INPUT_FILES="'/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_reanalysis_bufr_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_radar_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_metar_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_dew_point_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_altimeter_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_gps_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_gts_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_vortex_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_IASI_O3_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_MOPITT_CO_mod.f90',
                       '/glade/home/mizzi/TRUNK/DART_DEVEL/obs_def/obs_def_MODIS_AOD_mod.f90'"
#
# &obs_kind_nml
...
# DOMAINS
   ...
   export NL_ETA_LEVELS=1.000,0.983,0.970,0.954,0.934,0.909,0.880,\
0.834,0.788,0.742,0.697,0.617,0.546,0.480,0.422,0.368,0.321,\
0.278,0.239,0.205,0.174,0.147,0.123,0.102,0.0832,0.0668,0.0526,\
0.0402,0.0295,0.0203,0.0124,0.00575,0.000
#
# PHYSICS
...
#BSUB -q ${JOB_CLASS}
#
./advance_model.ksh 1 1 filter_control_${KMEM} > index.html 2>&1 
...
# Copy ensemble member wrfout to filter directory 
            cp ${RUN_DIR}/${PAST_DATE}/wrfchem_forecast/wrfout_d${DOMAIN}_${L_FILE_DATE}_${KMEM} wrfinput_d${DOMAIN}
#
# Run wrf_to_dart
            ./wrf_to_dart
...
# Get the obs_seq.out file for current cycle
         export FILE=obs_seq_${L_DATE}.out
         if [[ ${CHEM_TYPE} == NONE ]]; then export FILE=obs_seq.out; fi
         if ${USE_HSI}; then
            hsi get obs_seq.out : ${HSI_DATA_DIR}/${OBS_DIR}/${L_DATE}/${FILE}
         else
            cp ${DATA_DIR}/${OBS_DIR}/${L_DATE}/${FILE} obs_seq.out
         fi
#
# Generate input.nml
         set -A temp `echo ${ASIM_MIN_DATE} 0 -g | ./advance_time`
