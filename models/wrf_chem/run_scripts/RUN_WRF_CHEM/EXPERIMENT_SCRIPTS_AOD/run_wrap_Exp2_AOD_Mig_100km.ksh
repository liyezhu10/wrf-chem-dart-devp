...
export W_START_DATE=2008060900
export W_END_DATE=2008060918
export W_END_DATE=2008060900
...
export W_EXPERIMENT=Ex2_AOD_Mg_100km
...
export W_RUN_SCRIPT_DIR=${W_DART_DIR}/models/wrf_chem/run_scripts/RUN_WRF_CHEM/EXPERIMENT_SCRIPTS_AOD
...
cp ${W_RUN_SCRIPT_DIR}/run_Exp2_AOD_Mig_DA_100km.ksh run_script.ksh
