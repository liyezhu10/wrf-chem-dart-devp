...
export OBS_SEQ_DIR=obs_MODCOMB_AOD_RAWR_SINGLE_CLUSTER_filt
export OBS_SEQ_DIR=obs_MODIS_AOD_RAWR_SINGLE_CLUSTER
...
export PROJECT_DIR=${W_PROJECT_DIR}
...
#                                      'MODIS_AOD_RETRIEVAL'"
   export NL_ASSIMILATE_THESE_OBS_TYPES="'MODIS_AOD_RETRIEVAL'"
