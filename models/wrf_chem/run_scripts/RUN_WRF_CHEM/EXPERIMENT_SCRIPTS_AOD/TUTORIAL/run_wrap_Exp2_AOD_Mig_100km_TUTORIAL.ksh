...
export W_EXPERIMENT=Ex2_AOD_Mg_100km_Tutorial
export W_NL_LOCALIZATION_CUTOFF=.025
export W_NL_LOCALIZATION_CUTOFF=.05
export W_NL_LOCALIZATION_CUTOFF=.1
export W_NL_LOCALIZATION_CUTOFF=.2
export W_OUTPUT_NAME=DART_TEST_AVE/MODCOMB_AOD_Exp_2_MgDA_20M_100km_TUTORIAL
...
export W_RUN_SCRIPT_DIR=${W_DART_DIR}/models/wrf_chem/run_scripts/RUN_WRF_CHEM/EXPERIMENT_SCRIPTS_AOD/TUTORIAL
#
...
cp ${W_RUN_SCRIPT_DIR}/run_Exp2_AOD_Mig_DA_100km_TUTORIAL.ksh run_script.ksh
