...
export W_START_DATE=2008060818
...
export W_EXPERIMENT=Ex2_MOPnIASnMOD_Mg_100km
...
cp ${W_RUN_SCRIPT_DIR}/run_Exp2_MOPnIASnMOD_Mig_DA_100km_CPSR.ksh run_script.ksh
...
# start with filter
       ...
       export W_WARM_WRFCHEM=false
# start with WRF-Chem or with SPECIAL_FORECAST
#       export W_WARM_FILTER=false
