...
export TIME_LIMIT_FILTER=5:50
export TIME_LIMIT_WRF=0:59
export NUM_TASKS=32
export TASKS_PER_NODE=8
export JOB_CLASS_CONV=geyser
export JOB_CLASS_FILTER=geyser
export JOB_CLASS_WRF=geyser
#
...
# Add coordinate attribute
               ...
               ncatted -O -a coordinates,ebu_in_bc,c,c,"XLONG, XLAT" wrfchemi_d${DOMAIN}_${LL_FILE_DATE}
...
# One WRFCHEM file as template
               if [[ ${LL_DATE} -eq ${L_DATE} ]]; then
                  cp wrfinput_d${DOMAIN}_$L_FILE_DATE} ${CENTRALDIR}/wrfinput_d${DOMAIN}
