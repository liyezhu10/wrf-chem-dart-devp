...
export SPECIAL_FORECAST_MEM[3]=11
export SPECIAL_FORECAST_MEM[4]=12
export SPECIAL_FORECAST_MEM[5]=13
export SPECIAL_FORECAST_MEM[6]=14
export SPECIAL_FORECAST_MEM[7]=15
export SPECIAL_FORECAST_MEM[8]=16
export SPECIAL_FORECAST_MEM[9]=17
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnIASnMOD_Exp_2_Test_Indep
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnIASnMOD_Exp_2_Test_Joint
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnIASnMOD_Exp_2_Test_Varloc
