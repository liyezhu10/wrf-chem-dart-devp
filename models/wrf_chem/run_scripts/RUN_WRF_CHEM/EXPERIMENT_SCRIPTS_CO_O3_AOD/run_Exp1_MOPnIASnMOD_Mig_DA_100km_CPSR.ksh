...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPnIASnMOD_Exp_1_MgDA_20M_100km_COnXXnAOD_CPSR
mkdir -p ${RUN_DIR}
#
...
#                                      'IASI_CO_RETRIEVAL',
#                                      'MODIS_AOD_RETRIEVAL'"
   export NL_EVALUATE_THESE_OBS_TYPES="'MOPITT_CO_RETRIEVAL','IASI_CO_RETRIEVAL','MODIS_AOD_RETRIEVAL'"
#
