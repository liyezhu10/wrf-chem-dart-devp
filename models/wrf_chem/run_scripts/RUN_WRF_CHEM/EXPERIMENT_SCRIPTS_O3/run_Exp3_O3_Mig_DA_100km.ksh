...
export OBS_SEQ_DIR=obs_IASCOMB_O3_Mig_DA_filt
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/IASCOMB_O3_Exp_3_MgDA_20M_100km_p10p00
export HSI_SAVE_DIR=${HSI_DIR}/DART_TEST_AVE/IASCOMB_O3_Exp_3_MgDA_20M_100km_p10p00
mkdir -p ${RUN_DIR}
