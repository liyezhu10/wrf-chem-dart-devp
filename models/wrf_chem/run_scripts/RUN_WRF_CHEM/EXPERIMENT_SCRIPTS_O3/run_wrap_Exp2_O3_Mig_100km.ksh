...
export W_EXPERIMENT=Ex2_O3_Mg_p10p30_100km
...
export W_RUN_SCRIPT_DIR=${W_DART_DIR}/models/wrf_chem/run_scripts/RUN_WRF_CHEM/EXPERIMENT_SCRIPTS_O3
...
cp ${W_RUN_SCRIPT_DIR}/run_Exp2_O3_Mig_DA_100km.ksh run_script.ksh
