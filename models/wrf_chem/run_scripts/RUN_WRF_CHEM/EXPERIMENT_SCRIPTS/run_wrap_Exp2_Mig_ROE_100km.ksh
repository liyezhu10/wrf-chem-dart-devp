...
export W_EXPERIMENT=Ex2_Mg_ROE_p10p30_100km
export NL_APM_SCALE=0.75
export NL_APM_SCALE_SW=.TRUE.
...
cp ${W_RUN_SCRIPT_DIR}/run_Exp2_Mig_DA_ROE_100km.ksh run_script.ksh
