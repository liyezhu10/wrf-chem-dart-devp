...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPCOMB_Exp_2_MgDA_20M_100km_bar_2_p10p30
export HSI_SAVE_DIR=${HSI_DIR}/DART_TEST_AVE/MOPCOMB_Exp_2_MgDA_20M_100km_bar_2_p10p30
mkdir -p ${RUN_DIR}
...
# &model_nml
   ...
   export NL_VERT_LOCALIZATION_COORD=2
...
#   export NL_VERTICAL_NORMALIZATION_PRESSURE=100000.0
   export NL_VERTICAL_NORMALIZATION_PRESSURE=120000.0
#
