...
export RUN_DIR=/glade/scratch/mizzi/DART_TEST_AVE/MOPCOMB_Exp_2_TRet_60M_HL
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE/MOPCOMB_Exp_2_TRet_60M_HL
mkdir -p ${RUN_DIR}
