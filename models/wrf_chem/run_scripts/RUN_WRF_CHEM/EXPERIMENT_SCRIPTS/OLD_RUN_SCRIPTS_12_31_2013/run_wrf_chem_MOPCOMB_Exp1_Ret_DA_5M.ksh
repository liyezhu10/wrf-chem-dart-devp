...
export DART_VER=DART_DEVEL_COM_TEST
...
export RUN_DIR=/glade/scratch/mizzi/DART_TEST_AVE/MOPCOMB_Exp_1_RtDA_5M_HL
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE/MOPCOMB_Exp_1_RtDA_5M_HL
mkdir -p ${RUN_DIR}
