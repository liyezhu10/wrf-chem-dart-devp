...
export TIME_LIMIT_WRFCHEM=1:59
export NUM_TASKS=32
...
export RUN_DIR=/glade/p/acd/mizzi/DART_TEST_AVE/MOPCOMB_Exp_2_RtDA_60M
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE/MOPCOMB_Exp_2_RtDA_60M
mkdir -p ${RUN_DIR}
