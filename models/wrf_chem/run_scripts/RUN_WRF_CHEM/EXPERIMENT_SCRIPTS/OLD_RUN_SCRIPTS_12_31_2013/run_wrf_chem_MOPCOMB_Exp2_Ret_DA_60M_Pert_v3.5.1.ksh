...
export START_DATE=2008061000
export END_DATE=2008061100
...
export RUN_DIR=/glade/scratch/mizzi/DART_TEST_AVE/MOPCOMB_Exp_2_RtDA_60M_N2_v3.5.1
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE/MOPCOMB_Exp_2_RtDA_60M_N2_v3.5.1
mkdir -p ${RUN_DIR}
...
# NAMELIST CHEM
   ...
   export NL_BIOEMDT=12
   export NL_PHOTDT=12
   export NL_CHEMDT=1.50
...
# Generate DART input.nml and WRFCHEM namelist.input files
   ...
   rm namelist.input
   rm input.nml
   ${DART_DIR}/models/wrf_chem/namelist_scripts/WRFCHEM/wrfchemv3.5.1_create_namelist.input.ksh
   ${DART_DIR}/models/wrf_chem/namelist_scripts/DART/dart_create_input.nml.ksh
#
...
#
# APM_TEMP
         ncatted -a MMINLU,global,c,c,USGS wrfbiochemi_d${DOMAIN}_${L_FILE_DATE}
         ncatted -a NUM_LAND_CAT,global,c,i,24 wrfbiochemi_d${DOMAIN}_${L_FILE_DATE}
      else
         cp ${DATA_DIR}/${EMISSIONS_DIR}/${L_YY}${L_MM}${L_DD}/wrfbiochemi_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} ${WRFCHEM_RUN_DIR}/wrfbiochemi_d${DOMAIN}_${L_FILE_DATE}
#
# APM_TEMP
         ncatted -a MMINLU,global,c,c,USGS wrfbiochemi_d${DOMAIN}_${L_FILE_DATE}
         ncatted -a NUM_LAND_CAT,global,c,i,24 wrfbiochemi_d${DOMAIN}_${L_FILE_DATE}
...
#
# APM_TEMP
            ncatted -a NUM_LAND_CAT,global,c,i,24 wrfchemi_d${DOMAIN}_${LL_FILE_DATE}
            ncatted -a NUM_LAND_CAT,global,c,i,24 wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}
         ...
         while [[ ${LL_DATE} -le ${NEXT_DATE} ]]; do
            ...
            export LL_HH=`echo ${LL_DATE} | cut -c9-10`
            export LL_FILE_DATE=${LL_YY}-${LL_MM}-${LL_DD}_${LL_HH}:00:00
            cp ${DATA_DIR}/${EMISSIONS_DIR}/${LL_YY}${LL_MM}${LL_DD}/wrfchemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM} ${WRFCHEM_RUN_DIR}/wrfchemi_d${DOMAIN}_${LL_FILE_DATE}
            cp ${DATA_DIR}/${EMISSIONS_DIR}/${LL_YY}${LL_MM}${LL_DD}/wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM} ${WRFCHEM_RUN_DIR}/wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}
#
# APM_TEMP
            ncatted -a NUM_LAND_CAT,global,c,i,24 wrfchemi_d${DOMAIN}_${LL_FILE_DATE}
            ncatted -a NUM_LAND_CAT,global,c,i,24 wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}
