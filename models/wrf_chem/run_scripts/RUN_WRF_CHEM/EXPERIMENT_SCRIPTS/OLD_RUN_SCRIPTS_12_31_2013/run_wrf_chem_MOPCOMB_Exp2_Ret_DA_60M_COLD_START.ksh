...
export EMISSIONS_DIR=chem_static_old
...
export RUN_DIR=/glade/scratch/mizzi/DART_TEST_AVE/MOPCOMB_Exp_2_RtDA_60M_CTL
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE/MOPCOMB_Exp_3_RtDA_60M_CTL
mkdir -p ${RUN_DIR}
...
# Copy necessary executables from DART to $CENTRALDIR
   cp ${DART_DIR}/models/wrf_chem/shell_scripts/advance_model_old.ksh ${CENTRALDIR}/advance_model.ksh
