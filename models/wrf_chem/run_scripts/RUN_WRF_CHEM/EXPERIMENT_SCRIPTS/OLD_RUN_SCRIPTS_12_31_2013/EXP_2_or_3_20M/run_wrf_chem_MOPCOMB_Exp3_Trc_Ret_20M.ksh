...
export RUN_DIR=/glade/p/acd/mizzi/DART_TEST_AVE/MOPCOMB_Exp_3_TRet_20M
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE/MOPCOMB_Exp_3_TRet_20M
mkdir -p ${RUN_DIR}
