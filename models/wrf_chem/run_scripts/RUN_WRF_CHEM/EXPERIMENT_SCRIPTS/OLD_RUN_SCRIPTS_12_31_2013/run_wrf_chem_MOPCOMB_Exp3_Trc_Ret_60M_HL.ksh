...
export OBS_SEQ_DIR=obs_MOPCOMB_Ret_DA_filt
...
export RUN_DIR=/glade/scratch/mizzi/DART_TEST_AVE/MOPCOMB_Exp_3_TRet_60M_HL
export HSI_SAVE_DIR=/MIZZI/DART_TEST_AVE/MOPCOMB_Exp_3_TRet_60M_HL
mkdir -p ${RUN_DIR}
...
#
# Start of COLD START CODE
            if [[ ${COLD_START_FLG} -eq 1 ]]; then
               echo APM: COLD START required for member ${KMEM}
#
