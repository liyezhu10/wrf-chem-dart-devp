...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPCOMB_Exp_3_MgDA_20M_100km_p10p00
export HSI_SAVE_DIR=${HSI_DIR}/DART_TEST_AVE/MOPCOMB_Exp_3_MgDA_20M_100km_p10p00
mkdir -p ${RUN_DIR}
