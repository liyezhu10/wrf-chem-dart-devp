...
export EMISSIONS_DIR=chem_static_test_p00
#export EMISSIONS_DIR=chem_static_test_p05
#export EMISSIONS_DIR=chem_static_test_p35
#export EMISSIONS_DIR=chem_static_test_p10
#export EMISSIONS_DIR=chem_static_test_p20
#export EMISSIONS_DIR=chem_static_test_p40
#export EMISSIONS_DIR=chem_static_test_p30
#export WPB_RC_DIR=wpb_rc_chem_N20S05
#export WPB_RC_DIR=wpb_rc_chem_test_p05
#export WPB_RC_DIR=wpb_rc_chem_test_p35
export WPB_RC_DIR=wpb_rc_chem_test_p10
#export WPB_RC_DIR=wpb_rc_chem_test_p20
#export WPB_RC_DIR=wpb_rc_chem_test_p40
#export WPB_RC_DIR=wpb_rc_chem_test_p30
export OBS_SEQ_DIR=obs
export OBS_SEQ_DIR=obs_MOPCOMB_Trc_Ret_filt_A
export OBS_SEQ_DIR=obs_MOPCOMB_Ret_DA_filt_A
...
export TIME_LIMIT_FILTER=4:59
export TIME_LIMIT_WRF=1:59
export NUM_TASKS=32
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPCOMB_Exp_3_MgDA_20M_p10p00
export HSI_SAVE_DIR=${HSI_DIR}/DART_TEST_AVE/MOPCOMB_Exp_3_MgDA_20M_p10p00
mkdir -p ${RUN_DIR}
...
#      hsi get ${CENTRALDIR}/wrfinput_d${DOMAIN} : ${HSI_DATA_DIR}/${WPB_RC_DIR}/${INITIAL_DATE}/wrfinput_d${DOMAIN}_${INITIAL_FILE_DATE}.e001
      htar -xv -f ${HSI_DATA_DIR}/${WPB_RC_DIR}/${INITIAL_DATE}.tar wrfinput_d${DOMAIN}_${INITIAL_FILE_DATE}.e001
      mv wrfinput_d${DOMAIN}_${INITIAL_FILE_DATE}.e001 ${CENTRALDIR}/wrfinput_d${DOMAIN}
   else
...
#      hsi get ${HSI_DATA_DIR}/${EMISSIONS_DIR}/wrf_season_wes_usgs_d${DOMAIN}.nc 
      htar -xv -f ${HSI_DATA_DIR}/${EMISSIONS_DIR}/clim_p_trop.nc.tar clim_p_trop.nc 
      htar -xv -f ${HSI_DATA_DIR}/${EMISSIONS_DIR}/exo_coldens_d${DOMAIN}.tar exo_coldens_d${DOMAIN} 
      htar -xv -f ${HSI_DATA_DIR}/${EMISSIONS_DIR}/ubvals_b40.20th.track1_1996-2005.nc.tar ubvals_b40.20th.track1_1996-2005.nc 
      htar -xv -f ${HSI_DATA_DIR}/${EMISSIONS_DIR}/wrf_season_wes_usgs_d${DOMAIN}.nc.tar wrf_season_wes_usgs_d${DOMAIN}.nc 
   else
...
# TIME CONTROL
   ...
   export NL_START_YEAR=${L_YY}
   export NL_START_MONTH=${L_MM}
   export NL_START_DAY=${L_DD}
   export NL_START_HOUR=${L_HH}
...
#         hsi get wrfinput_d${DOMAIN} : ${HSI_DATA_DIR}/${WPB_RC_DIR}/${L_DATE}/wrfinput_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} 
         htar -xv -f ${HSI_DATA_DIR}/${WPB_RC_DIR}/${L_DATE}.tar wrfinput_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} 
         mv wrfinput_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} wrfinput_d${DOMAIN}
      else
...
#         hsi get wrfbdy_d${DOMAIN}_${NEXT_DAY_GREG}_${NEXT_SEC_GREG}_${KMEM} : ${HSI_DATA_DIR}/${WPB_RC_DIR}/${L_DATE}/wrfbdy_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} 
         htar -xv -f ${HSI_DATA_DIR}/${WPB_RC_DIR}/${L_DATE}.tar wrfbdy_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} 
         mv wrfbdy_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} wrfbdy_d${DOMAIN}_${NEXT_DAY_GREG}_${NEXT_SEC_GREG}_${KMEM}
      else
...
#         hsi get wrfbiochemi_d${DOMAIN}_${L_FILE_DATE} : ${HSI_DATA_DIR}/${EMISSIONS_DIR}/${L_YY}${L_MM}${L_DD}/wrfbiochemi_d${DOMAIN}_${L_FILE_DATE}.e${CMEM}
         htar -xv -f ${HSI_DATA_DIR}/${EMISSIONS_DIR}/${L_YY}${L_MM}${L_DD}.tar wrfbiochemi_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} 
         mv wrfbiochemi_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} wrfbiochemi_d${DOMAIN}_${L_FILE_DATE} 
      else
...
#            hsi get wrffirechemi_d${DOMAIN}_${LL_FILE_DATE} : ${HSI_DATA_DIR}/${EMISSIONS_DIR}/${LL_YY}${LL_MM}${LL_DD}/wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM}
            htar -xv -f ${HSI_DATA_DIR}/${EMISSIONS_DIR}/${LL_YY}${LL_MM}${LL_DD}.tar wrfchemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM}
            htar -xv -f ${HSI_DATA_DIR}/${EMISSIONS_DIR}/${LL_YY}${LL_MM}${LL_DD}.tar wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM} 
            mv get wrfchemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM} wrfchemi_d${DOMAIN}_${LL_FILE_DATE}
            mv get wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM} wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}
...
#      hsi "mkdir -p ${HSI_SAVE_DIR}/${L_DATE}; cd ${HSI_SAVE_DIR}/${L_DATE}; put -R wrfchem_forecast"
      cd ${RUN_DIR}
      htar -cv -f ${HSI_SAVE_DIR}/${L_DATE}.tar ${RUN_DIR}/${L_DATE}
   fi
fi
...
#            hsi get obs_seq.out : ${HSI_DATA_DIR}/${OBS_SEQ_DIR}/${L_DATE}/${FILE}
            htar -xv -f ${HSI_DATA_DIR}/${OBS_SEQ_DIR}/${L_DATE}.tar ${FILE}
            mv ${FILE} obs_seq.out
         else
...
#               hsi get wrfinput_d${DOMAIN}_${NEXT_DAY_GREG}_${NEXT_SEC_GREG}_${KMEM} : ${HSI_SAVE_DIR}/${PAST_DATE}/wrfchem_forecast/wrfout_d${DOMAIN}_${L_FILE_DATE}_${KMEM} 
               htar -xv -f ${HSI_SAVE_DIR}/${PAST_DATE}.tar wrfchem_forecast/wrfout_d${DOMAIN}_${L_FILE_DATE}_${KMEM}
               mv wrfchem_forecast/wrfout_d${DOMAIN}_${L_FILE_DATE}_${KMEM} wrfinput_d${DOMAIN}_${NEXT_DAY_GREG}_${NEXT_SEC_GREG}_${KMEM}
            else
...
#                  hsi get wrffirechemi_d${DOMAIN}_${LL_FILE_DATE} : ${HSI_DATA_DIR}/${EMISSIONS_DIR}/${LL_YY}${LL_MM}${LL_DD}/wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM}
               ...
               htar -xv -f ${HSI_DATA_DIR}/${EMISSIONS_DIR}/${LL_YY}${LL_MM}${LL_DD}.tar wrfchemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM}
               htar -xv -f ${HSI_DATA_DIR}/${EMISSIONS_DIR}/${LL_YY}${LL_MM}${LL_DD}.tar wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM}
               mv wrfchemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM} wrfchemi_d${DOMAIN}_${LL_FILE_DATE}
               mv wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}.e${CMEM} wrffirechemi_d${DOMAIN}_${LL_FILE_DATE}
               done
            else
               export LL_DATE=${L_DATE}
               while [[ ${LL_DATE} -le ${NEXT_DATE} ]]; do
...
#                     hsi get ${CENTRALDIR}/WRF/wrfinput_d${DOMAIN}_${NEXT_DAY_GREG}_${NEXT_SEC_GREG}_${KMEM} : ${HSI_SAVE_DIR}/${PAST_DATE}/wrfchem_forecast/wrfout_d${DOMAIN}_${L_FILE_DATE}_${KMEM} 
                     htar -xv -f ${HSI_SAVE_DIR}/${PAST_DATE}.tar wrfchem_forecast/wrfout_d${DOMAIN}_${L_FILE_DATE}_${KMEM} 
                     mv wrfchem_forecast/wrfout_d${DOMAIN}_${L_FILE_DATE}_${KMEM}  ${CENTRALDIR}/WRF/wrfinput_d${DOMAIN}_${NEXT_DAY_GREG}_${NEXT_SEC_GREG}_${KMEM}
                  else
                  ...
                  if [[ ! -e ${CENTRALDIR}/WRF/wrfinput_d${DOMAIN}_${NEXT_DAY_GREG}_${NEXT_SEC_GREG}_${KMEM} ]]; then echo APM: cp ${CENTRALDIR}/WRF/wrfinput_d${DOMAIN}_${NEXT_DAY_GREG}_${NEXT_SEC_GREG}_${KMEM} failed; exit; fi               fi
#
# One WRFINPUT file as template to $CENTRALDIR
...
#                     hsi get wrfbdy_d${DOMAIN} : ${HSI_DATA_DIR}/${WPB_RC_DIR}/${L_DATE}/wrfbdy_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} 
                     ...
                     htar -xv -f ${HSI_DATA_DIR}/${WPB_RC_DIR}/${L_DATE}.tar wrfbdy_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} 
                     mv wrfinput_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} wrfinput_d${DOMAIN} 
                     mv wrfbdy_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} wrfbdy_d${DOMAIN} 
                  else
                     cp ${DATA_DIR}/${WPB_RC_DIR}/${L_DATE}/wrfinput_d${DOMAIN}_${L_FILE_DATE}.e${CMEM} wrfinput_d${DOMAIN}
