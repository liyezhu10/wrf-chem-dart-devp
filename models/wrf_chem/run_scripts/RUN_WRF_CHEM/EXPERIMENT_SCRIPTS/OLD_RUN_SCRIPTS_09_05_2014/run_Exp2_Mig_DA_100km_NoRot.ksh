...
export OBS_SEQ_DIR=obs_MOPCOMB_Mig_DA_no_rot1_bloc_filt
...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPCOMB_Exp_2_MgDA_20M_100km_NoRot_bloc_p10p30
export HSI_SAVE_DIR=${HSI_DIR}/DART_TEST_AVE/MOPCOMB_Exp_2_MgDA_20M_100km_NoRot_bloc_p10p30
mkdir -p ${RUN_DIR}
