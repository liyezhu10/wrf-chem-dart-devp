...
export RUN_DIR=${SCRATCH_DIR}/DART_TEST_AVE/MOPCOMB_Exp_2_Mg_MOPnXXX_20M_100km_p10p30
export HSI_SAVE_DIR=${HSI_DIR}/DART_TEST_AVE/MOPCOMB_Exp_2_Mg_MOPnXXX_20M_100km_p10p30
mkdir -p ${RUN_DIR}
