...
#
# compile code
ifort -check none -CB -C localize_obs_seq_IASI_CO.f90 -o localize_obs_seq_IASI_CO.exe -lncarg -lncarg_gks -lncarg_c -lX11 -lXext -lcairo -lfontconfig -lpixman-1 -lfreetype -lexpat -lpng -lz -lpthread -lbz2 -lXrender -lgfortran -lnetcdff -lnetcdf
./localize_obs_seq_IASI_CO.exe
exit
#
# Create job script 
RANDOM=$$
...
rm -rf job_*.err
rm -rf job_*.index
./localize_obs_seq_IASI_CO.exe > ${JOBRND}.index 2>&1 
#
export RC=\$?     
