...
export RUN_DIR=${FRAPPE_DIR}/real_PANDA_RETR_VARLOC
...
export WRFCHEM_DIR_GABI=${TRUNK_DIR}/${WRFCHEM_VER_GABI}
...
export FRAPPE_WRFCHEMI_DIR=${FRAPPE_DATA_DIR}/anthro_emissions_PANDA
...
#  if [[ ${YYYY} -eq 2014 ]]; then export MOZART_DATA=h0004.nc; fi
  if [[ ${YYYY} -eq 2014 ]]; then export MOZART_DATA=h0005.nc; fi
#
