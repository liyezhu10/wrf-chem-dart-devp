...
export INITIAL_DATE=2014072518
export FIRST_FILTER_DATE=2014072600
...
export DART_VER=mizzi
#
# ROOT DIRECTORIES:
export SCRATCH_DIR=/glade/scratch/thoar
export WORK_DIR=/glade/p/work/thoar/DART
export ACD_DIR=/glade/p/acd/mizzi
export FRAPPE_DIR=/glade/p/FRAPPE
export UTILITIES_DIR=/glade/p/work/mizzi/TRUNK
#
# DEPENDENT INPUT DATA DIRECTORIES:
export EXPERIMENT_DIR=${FRAPPE_DIR}
export RUN_DIR=/glade/scratch/thoar/real_FRAPPE_CPSR_VARLOC
export TRUNK_DIR=${WORK_DIR}
export WPS_DIR=${UTILITIES_DIR}/${WPS_VER}
export WPS_GEOG_DIR=${UTILITIES_DIR}/${WPS_GEOG_VER}/geog
export WRFCHEM_DIR=${UTILITIES_DIR}/${WRFCHEM_VER}
export WRFCHEM_DIR_GABI=${FRAPPE_DIR}/FRAPPE_TRUNK/${WRFCHEM_VER_GABI}
export WRFDA_DIR=${UTILITIES_DIR}/${WRFDA_VER}
export DART_DIR=${TRUNK_DIR}/${DART_VER}
export BUILD_DIR=${WRFDA_DIR}/var/da
export WRF_DIR=${UTILITIES_DIR}/${WRF_VER}
...
#
# COMPUTER PARAMETERS:
export PROJ_NUMBER=P86850054
export PROJ_NUMBER_ACD=P86850054
export PROJ_NUMBER_NSC=P86850054
