...
export RUN_DIR=${SCRATCH_DIR}/real_time_wrf_chem_nested_v3.6.1
...
export NL_I_PARENT_START=0,${ISTR_FR}
export NL_J_PARENT_START=0,${JSTR_FR}
export NL_S_WE=1,1
...
export NL_FINE_INPUT_STREAM=0,0
...
export NL_DX=100000.0,50000.0
export NL_DY=100000.0,50000.0
...
# CREATE WRF NAMELIST
      ...
      export NL_START_DATE="'"${L_START_YEAR}-${L_START_MONTH}-${L_START_DAY}_${L_START_HOUR}:00:00"'","'"${L_START_YEAR}-${L_START_MONTH}-${L_START_DAY}_${L_START_HOUR}:00:00"'"
      export NL_END_DATE="'"${L_END_YEAR}-${L_END_MONTH}-${L_END_DAY}_${L_END_HOUR}:00:00"'","'"${L_END_YEAR}-${L_END_MONTH}-${L_END_DAY}_${L_END_HOUR}:00:00"'"
      ${HYBRID_SCRIPTS_DIR}/da_create_wrfchem_namelist_nested.ksh
#
# JOB SCRIPT
      if [[ -f job.ksh ]]; then rm -rf job.ksh; fi
      rm -rf *.err
...
# FINE RESOLUTION GRID
         ...
         export NL_DX=50000.0
         export NL_DY=50000.0
         export NL_GRID_ID=2
         export NL_PARENT_ID=1
         export NL_PARENT_GRID_RATIO=2
...
#
   while [[ ${L_DATE} -le ${LE_DATE} ]]; do
      ...
      export L_HH=$(echo $L_DATE | cut -c9-10)
#
      export FILE_PATH=${ACD_DIR}/AVE_TEST_DATA/chem_static_100km/${L_YYYY}${L_MM}${L_DD}
