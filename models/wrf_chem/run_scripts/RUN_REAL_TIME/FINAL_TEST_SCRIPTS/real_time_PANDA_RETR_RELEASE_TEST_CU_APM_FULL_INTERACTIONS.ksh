...
# DEPENDENT INPUT DATA DIRECTORIES:
   ...
   export RUN_DIR=${EXPERIMENT_DIR}/real_PANDA_RETR_VARLOC_RELEASE_TEST_Manhattan
...
# &model_nml
   ...
   export NL_CONV_STATE_VARIABLES="'U',     'QTY_U_WIND_COMPONENT',     'TYPE_U',  'UPDATE','999',
          ...
          'P10','QTY_PM10',                    'TYPE_P10','UPDATE','999',
          'P25','QTY_PM25',                    'TYPE_P25','UPDATE','999',
...
#
# GET DART UTILITIES
         cp ${WRF_CHEM_WORK_DIR}/wrf_dart_obs_preprocess ./.
...
# Create namelist
      ...
      cp ${EXPERIMENT_STATIC_FILES}/ubvals_b40.20th.track1_1996-2005.nc ./.
#
# APM: This code block is new for Manhattan +++
