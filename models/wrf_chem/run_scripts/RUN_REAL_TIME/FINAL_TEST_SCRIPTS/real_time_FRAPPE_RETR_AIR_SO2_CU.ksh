...
if [[ ${USE_LOG} == true ]]; then
   ...
   export SO4_MIN=NULL
   export SO4_MAX=NULL
   export DUST_MIN=NULL
   export DUST_MAX=NULL
   export BC_MIN=NULL
   export BC_MAX=NULL
   export OC_MIN=NULL
   export OC_MAX=NULL
   export TAUAER_MIN=NULL
   export TAUAER_MAX=NULL
   export SEAS_MIN=NULL
   export SEAS_MAX=NULL
   ...
   export AOD_MIN=NULL
   export AOD_MAX=NULL
   export E_CO_MIN=NULL
   export E_CO_MAX=NULL
   export E_NO_MIN=NULL
   export E_NO_MAX=NULL
   export E_NO2_MIN=NULL
   export E_NO2_MAX=NULL
   export E_SO2_MIN=NULL
   export E_SO2_MAX=NULL
   export E_SO4_MIN=NULL
   export E_SO4_MAX=NULL
   export E_BC_MIN=NULL
   export E_BC_MAX=NULL
   export E_OC_MIN=NULL
   export E_OC_MAX=NULL
   export E_PM25_MIN=NULL
   export E_PM25_MAX=NULL
   export E_PM10_MIN=NULL
   export E_PM10_MAX=NULL
   export EB_CO_MIN=NULL
   export EB_CO_MAX=NULL
   export EB_NO_MIN=NULL
   export EB_NO_MAX=NULL
   export EB_NO2_MIN=NULL
   export EB_NO2_MAX=NULL
   export EB_SO2_MIN=NULL
   export EB_SO2_MAX=NULL
   export EB_BC_MIN=NULL
   export EB_BC_MAX=NULL
   export EB_OC_MIN=NULL
   export EB_OC_MAX=NULL
   export EB_C2H4_MIN=NULL
   export EB_C2H4_MAX=NULL
   export EB_CH2O_MIN=NULL
   export EB_CH2O_MAX=NULL
   export EB_CH3OH_MIN=NULL
   export EB_CH3OH_MAX=NULL
else
   ...
   export EB_OC_MIN=0.
   export EB_OC_MAX=NULL
   export EB_C2H4_MIN=0.
   export EB_C2H4_MAX=NULL
   export EB_CH2O_MIN=0.
   export EB_CH2O_MAX=NULL
   export EB_CH3OH_MIN=0.
   export EB_CH3OH_MAX=NULL
fi
#
...
export SPECIAL_FORECAST_MEM[2]=15
export SPECIAL_FORECAST_MEM[3]=16
...
# DEPENDENT INPUT DATA DIRECTORIES:
   ...
   export RUN_DIR=${EXPERIMENT_DIR}/real_FRAPPE_RETR_AIR_SO2
...
# &model_nml
   ...
   export NL_CONV_STATE_VARIABLES="'U',     'KIND_U_WIND_COMPONENT',     'TYPE_U',  'UPDATE','999',
          ...
          'so2',   'KIND_SO2',                  'TYPE_SO2', 'UPDATE','999',
   ...
   export NL_WRF_STATE_BOUNDS="'QVAPOR','0.0','NULL','CLAMP',
          ...
          'DUST_1','${DUST_MIN}','${DUST_MAX}','CLAMP',
          'DUST_2','${DUST_MIN}','${DUST_MAX}','CLAMP',
          'DUST_3','${DUST_MIN}','${DUST_MAX}','CLAMP',
          'DUST_4','${DUST_MIN}','${DUST_MAX}','CLAMP',
          'DUST_5','${DUST_MIN}','${DUST_MAX}','CLAMP',
          'BC1','${BC_MIN}','${BC_MAX}','CLAMP',
          'BC2','${BC_MIN}','${BC_MAX}','CLAMP',
          'OC1','${OC_MIN}','${OC_MAX}','CLAMP',
          'OC2','${OC_MIN}','${OC_MAX}','CLAMP',
          'TAUAER1','${TAUAER_MIN}','${TAUAER_MAX}','CLAMP',
          'TAUAER2','${TAUAER_MIN}','${TAUAER_MAX}','CLAMP',
          'TAUAER3','${TAUAER_MIN}','${TAUAER_MAX}','CLAMP',
          'TAUAER4','${TAUAER_MIN}','${TAUAER_MAX}','CLAMP',
          'PM2_5_DRY','${PM25_MIN}','${PM25_MAX}','CLAMP',
          'PM10','${PM10_MIN}','${PM10_MAX}','CLAMP',
          'P25','${P25_MIN}','${P25_MAX}','CLAMP',
          'P10','${P10_MIN}','${P10_MAX}','CLAMP',
          'SEAS_1','${SEAS_MIN}','${SEAS_MAX}','CLAMP',
          'SEAS_2','${SEAS_MIN}','${SEAS_MAX}','CLAMP',
          'SEAS_3','${SEAS_MIN}','${SEAS_MAX}','CLAMP',
          'SEAS_4','${SEAS_MIN}','${SEAS_MAX}','CLAMP',
          'E_CO','${E_CO_MIN}','${E_CO_MAX}','CLAMP',
          'E_NO','${E_NO_MIN}','${E_NO_MAX}','CLAMP',
          'E_NO2','${E_NO2_MIN}','${E_NO2_MAX}','CLAMP',
          'E_SO2','${E_SO2_MIN}','${E_SO2_MAX}','CLAMP',
          'E_SO4I','${E_SO4_MIN}','${E_SO4_MAX}','CLAMP',
          'E_SO4J','${E_SO4_MIN}','${E_SO4_MAX}','CLAMP',
          'E_PM_25','${E_PM25_MIN}','${E_PM25_MAX}','CLAMP',
          'E_PM25I','${E_PM25_MIN}','${E_PM25_MAX}','CLAMP',
          'E_PM25J','${E_PM25_MIN}','${E_PM25_MAX}','CLAMP',
          'E_PM10','${E_PM10_MIN}','${E_PM10_MAX}','CLAMP',
          'E_EC1','${E_BC_MIN}','${E_BC_MAX}','CLAMP',
          'E_EC2','${E_BC_MIN}','${E_BC_MAX}','CLAMP',
          'E_ORG1','${E_OC_MIN}','${E_OC_MAX}','CLAMP',
          'E_ORG2','${E_OC_MIN}','${E_OC_MAX}','CLAMP',
          'E_PM_BC','${E_BC_MIN}','${E_BC_MAX}','CLAMP',
          'E_PM_OC','${E_OC_MIN}','${E_OC_MAX}','CLAMP',
          'ebu_in_co','${EB_CO_MIN}','${EB_CO_MAX}','CLAMP',
          'ebu_in_no','${EB_NO_MIN}','${EB_NO_MAX}','CLAMP',
          'ebu_in_no2','${EB_NO2_MIN}','${EB_NO2_MAX}','CLAMP',
          'ebu_in_so2','${EB_SO2_MIN}','${EB_SO2_MAX}','CLAMP',
          'ebu_in_oc','${EB_OC_MIN}','${EB_OC_MAX}','CLAMP',
          'ebu_in_bc','${EB_BC_MIN}','${EB_BC_MAX}','CLAMP',
          'ebu_in_c2h4','${EB_C2H4_MIN}','${EB_C2H4_MAX}','CLAMP',
          'ebu_in_ch2o','${EB_CH2O_MIN}','${EB_CH2O_MAX}','CLAMP',
          'ebu_in_ch3oh','${EB_CH3OH_MIN}','${EB_CH3OH_MAX}','CLAMP'"
...
# &preprocess_nml
   ...
   export NL_INPUT_FILES="'${DART_DIR}/obs_def/obs_def_reanalysis_bufr_mod.f90',
                    ...
                    '${DART_DIR}/obs_def/obs_def_AIRNOW_PM10_mod.f90',
                    '${DART_DIR}/obs_def/obs_def_AIRNOW_PM25_mod.f90',
...
# &obs_kind_nml
   export NL_ASSIMILATE_THESE_OBS_TYPES="'RADIOSONDE_TEMPERATURE',
                                   ...
                                   'AIRNOW_SO2'"
   export NL_EVALUATE_THESE_OBS_TYPES="'AIRNOW_NO2',
                                    'AIRNOW_O3',
                                    'AIRNOW_CO'"
#
...
# SERIAL VERSION
               RANDOM=$$
               export JOBRND=${RANDOM}_cr_emiss_pert
               ${HYBRID_SCRIPTS_DIR}/job_script_summit.ksh ${JOBRND} ${GENERAL_JOB_CLASS} ${GENERAL_TIME_LIMIT} ${GENERAL_NODES} ${GENERAL_TASKS} perturb_chem_emiss_ADD_PRIOR_INCRs.exe SERIAL
               sbatch -W job.ksh
            fi
         fi
#
...
EOFF
      sbatch -W job.ksh > index.file 2>&1
#
...
#
# All files present
      if [[ ${NL_NUM_INPUT_FILES} -eq 12 ]]; then export
         NL_FILENAME_SEQ=\'${FILE_LIST[1]}\',\'${FILE_LIST[2]}\',\'${FILE_LIST[3]}\',\'${FILE_LIST[4]}\',\'${FILE_LIST[5]}\',\'${FILE_LIST[6]}\',\'${FILE_LIST[7]}\',\'${FILE_LIST[8]}\',\'${FILE_LIST[9]}\',\'${FILE_LIST[10]}\',\'${FILE_LIST[11]}\',\'${FILE_LIST[12]}\'
      elif [[ ${NL_NUM_INPUT_FILES} -eq 11 ]]; then export
         NL_FILENAME_SEQ=\'${FILE_LIST[1]}\',\'${FILE_LIST[2]}\',\'${FILE_LIST[3]}\',\'${FILE_LIST[4]}\',\'${FILE_LIST[5]}\',\'${FILE_LIST[6]}\',\'${FILE_LIST[7]}\',\'${FILE_LIST[8]}\',\'${FILE_LIST[9]}\',\'${FILE_LIST[10]}\',\'${FILE_LIST[11]}\'
      elif [[ ${NL_NUM_INPUT_FILES} -eq 10 ]]; then export
         NL_FILENAME_SEQ=\'${FILE_LIST[1]}\',\'${FILE_LIST[2]}\',\'${FILE_LIST[3]}\',\'${FILE_LIST[4]}\',\'${FILE_LIST[5]}\',\'${FILE_LIST[6]}\',\'${FILE_LIST[7]}\',\'${FILE_LIST[8]}\',\'${FILE_LIST[9]}\',\'${FILE_LIST[10]}\'
      elif [[ ${NL_NUM_INPUT_FILES} -eq 9 ]]; then export
         NL_FILENAME_SEQ=\'${FILE_LIST[1]}\',\'${FILE_LIST[2]}\',\'${FILE_LIST[3]}\',\'${FILE_LIST[4]}\',\'${FILE_LIST[5]}\',\'${FILE_LIST[6]}\',\'${FILE_LIST[7]}\',\'${FILE_LIST[8]}\',\'${FILE_LIST[9]}\'
      elif [[ ${NL_NUM_INPUT_FILES} -eq 8 ]]; then export
         NL_FILENAME_SEQ=\'${FILE_LIST[1]}\',\'${FILE_LIST[2]}\',\'${FILE_LIST[3]}\',\'${FILE_LIST[4]}\',\'${FILE_LIST[5]}\',\'${FILE_LIST[6]}\',\'${FILE_LIST[7]}\',\'${FILE_LIST[8]}\'
