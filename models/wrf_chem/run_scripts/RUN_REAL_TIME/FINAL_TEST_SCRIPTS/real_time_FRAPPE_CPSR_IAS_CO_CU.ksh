...
1
export SPECIAL_FORECAST_MEM[1]=16
export SPECIAL_FORECAST_MEM[2]=27
export SPECIAL_FORECAST_MEM[3]=28
export SPECIAL_FORECAST_MEM[4]=29
...
# DEPENDENT INPUT DATA DIRECTORIES:
   ...
   export RUN_DIR=${EXPERIMENT_DIR}/real_FRAPPE_CPSR_IAS_CO_INF_DAMP
...
# &filter.nml
   ...
   export NL_INF_DAMPING_PRIOR=0.8
