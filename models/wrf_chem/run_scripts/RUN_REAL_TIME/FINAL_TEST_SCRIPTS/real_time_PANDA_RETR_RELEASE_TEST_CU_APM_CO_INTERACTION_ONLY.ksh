...
# &model_nml
   ...
   export NL_CONV_STATE_VARIABLES="'U',     'QTY_U_WIND_COMPONENT',     'TYPE_U',  'UPDATE','999',
          ...
          'BC1','QTY_BC1',                     'TYPE_EXTCOF','UPDATE','999',
          'BC2','QTY_BC2',                     'TYPE_EXTCOF','UPDATE','999',
...
END GROUP
#
GROUP chem_vars_E_CO
   QTY_E_CO
END GROUP
#
GROUP chem_vars_EBU_CO
   QTY_EBU_CO
END GROUP
#
GROUP chem_vars_CO
...
IMPACT
  ...
  chem_vars_no_co chem_vars 0.0
  chem_vars_E_CO chem_vars 0.0
  chem_vars_EBU_CO chem_vars 0.0
  chem_obs_CO chem_vars_no_CO 0.0
  chem_obs_CO chem_vars_CO 1.0
  chem_obs_CO chem_vars_EBU_CO 1.0
END IMPACT
EOF
#
# Create input.nml
...
# APM - no permission to copy this file
      cp ${EXPERIMENT_STATIC_FILES}/ubvals_b40.20th.track1_1996-2005.nc ./.
#
...
# Copy the adjusted emissions fields from the wrfinput files to the emissions input files
         ...
         ncks -O -v ${WRFFIRECHEMI_DARTVARS} wrfout_d${CR_DOMAIN}_temp.${CMEM} wrffirechemi_d${CR_DOMAIN}_${LL_FILE_DATE}.${CMEM}
