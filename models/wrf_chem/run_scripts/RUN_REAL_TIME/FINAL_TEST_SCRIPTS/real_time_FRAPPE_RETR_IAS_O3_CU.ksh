...
# CPSR Truncation (limit the number of CPSR modes assimilated)
   export NL_USE_CPSR_CO_TRUNC=.true.
   export NL_USE_CPSR_CO_TRUNC=.false.
   export NL_CPSR_CO_TRUNC_LIM=1
   export NL_CPSR_CO_TRUNC_LIM=2
   export NL_CPSR_CO_TRUNC_LIM=3
   export NL_USE_CPSR_O3_TRUNC=.true.
   export NL_USE_CPSR_O3_TRUNC=.false.
   export NL_CPSR_O3_TRUNC_LIM=1
   export NL_CPSR_O3_TRUNC_LIM=2
   export NL_CPSR_O3_TRUNC_LIM=3
#
...
export RUN_DIR=${EXPERIMENT_DIR}/real_FRAPPE_RETR_IAS_O3
