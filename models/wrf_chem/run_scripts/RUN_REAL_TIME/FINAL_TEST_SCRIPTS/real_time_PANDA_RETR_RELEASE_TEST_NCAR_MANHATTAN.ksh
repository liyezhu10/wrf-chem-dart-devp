...
# KRF: Copy files from ../wrfchem_fire and ../wrfchem_chemi since wrf-to-dart isn't run anymore
# KRF: Unclear how these are used.
 if [[ ${LL_DATE} -le ${FIRST_EMISS_INV_DATE} || ${ADD_EMISS} = ".false." ]]; then
