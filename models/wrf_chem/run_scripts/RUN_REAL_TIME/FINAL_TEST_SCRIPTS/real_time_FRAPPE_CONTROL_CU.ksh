...
export SPECIAL_FORECAST_MEM[1]=28
export SPECIAL_FORECAST_MEM[2]=29
export SPECIAL_FORECAST_MEM[3]=30
export SPECIAL_FORECAST_MEM[4]=19
export SPECIAL_FORECAST_MEM[5]=20
export SPECIAL_FORECAST_MEM[6]=22
export SPECIAL_FORECAST_MEM[7]=24
export SPECIAL_FORECAST_MEM[8]=27
#
...
# COMPUTER PARAMETERS:
   ...
   export FILTER_TIME_LIMIT=04:30:00
   ...
   export WRFCHEM_FR_JOB_CLASS=normal
   export WRFCHEM_FR_TIME_LIMIT=05:00:00
   export WRFCHEM_FR_NODES=2-4
   export WRFCHEM_FR_TASKS=48
...
#
      RANDOM=$$
      export JOBRND=${RANDOM}_wrf
      ${HYBRID_SCRIPTS_DIR}/job_script_summit.ksh ${JOBRND} ${WRFCHEM_FR_JOB_CLASS} ${WRFCHEM_FR_TIME_LIMIT} ${WRFCHEM_FR_NODES} ${WRFCHEM_FR_TASKS} wrf.exe PARALLEL ${ACCOUNT}
      sbatch -W job.ksh
   fi
#
#########################################################################
