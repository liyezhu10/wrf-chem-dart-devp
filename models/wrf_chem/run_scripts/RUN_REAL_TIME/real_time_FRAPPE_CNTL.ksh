...
export CYCLE_STR_DATE=2014080400
#export CYCLE_END_DATE=${CYCLE_STR_DATE}
export CYCLE_END_DATE=2014080400
...
export SPECIAL_FORECAST_MEM[1]=22
...
export SPECIAL_FORECAST_MEM[10]=11
export SPECIAL_FORECAST_MEM[11]=12
export SPECIAL_FORECAST_MEM[12]=13
export SPECIAL_FORECAST_MEM[13]=14
export SPECIAL_FORECAST_MEM[14]=15
export SPECIAL_FORECAST_MEM[15]=16
export SPECIAL_FORECAST_MEM[16]=17
export SPECIAL_FORECAST_MEM[17]=18
export SPECIAL_FORECAST_MEM[18]=19
export SPECIAL_FORECAST_MEM[19]=20
export SPECIAL_FORECAST_MEM[20]=21
export SPECIAL_FORECAST_MEM[21]=22
export SPECIAL_FORECAST_MEM[22]=23
export SPECIAL_FORECAST_MEM[23]=24
export SPECIAL_FORECAST_MEM[24]=25
export SPECIAL_FORECAST_MEM[25]=26
export SPECIAL_FORECAST_MEM[26]=27
export SPECIAL_FORECAST_MEM[27]=28
export SPECIAL_FORECAST_MEM[28]=29
export SPECIAL_FORECAST_MEM[29]=30
...
#
# for 20143106
#export BACK_DATE=2014073100
#export FORW_DATE=2014073112
#let BACK_WT=.5000
#
...
export DART_DIR=/glade/p/work/mizzi/TRUNK/DART_CHEM_MY_BRANCH_FRAPPE
...
#export WRFCHEM_VER=WRFCHEMv3.6.1_dmpar_GABI
export WRFCHEM_VER=WRFCHEMv3.6.1_dmpar_GABI_REV1.0
...
export RUN_DIR=${FRAPPE_DIR}/real_FRAPPE_CNTL_VARLOC_REV3.a
...
#export WRFCHEM_DIR_GABI=${TRUNK_DIR}/WRFCHEMv3.6.1_dmpar_GABI
export WRFCHEM_DIR_GABI=${TRUNK_DIR}/WRFCHEMv3.6.1_dmpar_GABI_REV1.0
...
#export NL_NUM_METGRID_LEVELS=26
...
# JOB SCRIPT 
         ...
         rm -rf *.out
         touch job.ksh
         export JOBRND=pert_bc_${RAN_APM}
         cat << EOF >job.ksh
#!/bin/ksh -aeux
#BSUB -P ${PROJ_NUMBER_NSC}
#BSUB -x
