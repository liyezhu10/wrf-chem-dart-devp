...
export FINAL_DATE=2008073100
export FINAL_DATE=2008061000
...
export DAT_DIR=/glade/scratch/mizzi/AVE_TEST_DATA
#
export HYBRID_SCRIPTS_DIR=${TRUNK_DIR}/HYBRID_TRUNK/hybrid_scripts
export GRIB_DIR=${DAT_DIR}/NAM_files
...
export WPS_GEOG_DIR=${WPS_DIR}/geog
