...
!
! DART $Id: mo_mozart_lib.f90 13171 2019-05-09 16:42:36Z thoar@ucar.edu $
...
!---------------------------------------------------------------
      call chk_moz_vars( nspec, filenm, .true. )
...
!     check mozart variables
!---------------------------------------------------------------
           call chk_moz_vars( nspec, filenm, .false. )
...
!-----------------------------------------------------------------------
      ...
      subroutine chk_moz_vars( nspec, filenm, verbose )
!---------------------------------------------------------------
