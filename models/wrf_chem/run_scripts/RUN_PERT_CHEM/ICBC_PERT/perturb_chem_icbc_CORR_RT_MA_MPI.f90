...
!
! mpif90 perturb_chem_icbc_CORR_RT_MA_MPI.f90 -o perturb_chem_icbc_CORR_RT_MA_MPI.exe -I$NETCDF/include -L$NETCDF/lib -lnetcdff -lnetcdf  (GNU Compilers)
!
! mpiifort -CB perturb_chem_icbc_CORR_RT_MA_MPI.f90 -o perturb_chem_icbc_CORR_RT_MA_MPI.exe -I$NETCDF/include -L$NETCDF/lib -lnetcdff -lnetcdf  (Intel Compilers)
!
          program main
             implicit none
             include 'mpif.h'
