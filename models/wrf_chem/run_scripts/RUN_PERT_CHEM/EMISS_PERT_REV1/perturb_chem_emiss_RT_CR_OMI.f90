...
!
! ifort -C perturb_chem_emiss_RT_CR_OMI.f90 -o perturb_chem_emiss_RT_CR_OMI.exe -lgfortran -lnetcdff -lnetcdf
!
          program main
             implicit none
             integer,parameter                        :: nx=280
             integer,parameter                        :: ny=220
             integer,parameter                        :: nz=30
             integer,parameter                        :: nz_chem=1
             integer,parameter                        :: nchem_spc=37
...
! Assign emission species names
             ...
             ch_chem_spc(8)='E_HC5'
             ch_chem_spc(9)='E_HC8'
             ch_chem_spc(10)='E_XYL'
             ch_chem_spc(11)='E_OL2'
             ch_chem_spc(12)='E_OLT'
             ch_chem_spc(13)='E_OLI'
             ch_chem_spc(14)='E_TOL'
             ch_chem_spc(15)='E_CSL'
             ch_chem_spc(16)='E_HCHO'
             ch_chem_spc(17)='E_ALD'
             ch_chem_spc(18)='E_KET'
             ch_chem_spc(19)='E_ORA2'
             ch_chem_spc(20)='E_NH3'
             ch_chem_spc(21)='E_PM25I'
             ch_chem_spc(22)='E_PM25J'
             ch_chem_spc(23)='E_PM_10'
             ch_chem_spc(24)='E_ECI'
             ch_chem_spc(25)='E_ECJ'
             ch_chem_spc(26)='E_ORGI'
             ch_chem_spc(27)='E_ORGJ'
             ch_chem_spc(28)='E_SO4I'
             ch_chem_spc(29)='E_SO4J'
             ch_chem_spc(30)='E_NO3I'
             ch_chem_spc(31)='E_NO3J'
             ch_chem_spc(32)='E_NAAI'
             ch_chem_spc(33)='E_NAAJ'
             ch_chem_spc(34)='E_ORGI_A'
             ch_chem_spc(35)='E_ORGJ_A'
             ch_chem_spc(36)='E_ORGI_BB'
             ch_chem_spc(37)='E_ORGJ_BB'
!
