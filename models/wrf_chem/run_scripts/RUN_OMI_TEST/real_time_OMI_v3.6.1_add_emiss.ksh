...
#
# CYCLE DATE-TIME:
export CYCLE_STR_DATE=2014070216
export CYCLE_STR_DATE=2014070217
#export CYCLE_END_DATE=2014070316
export CYCLE_END_DATE=2014070217
...
#
export RUN_DIR=/glade/scratch/mizzi/real_OMI_v3.6.1_add_emiss
...
export RUN_OMI_INPUT=true                ;# true
...
export RUN_OMI_NO2_OBS=true              ;# true
...
export NL_WRF_STATE_VARIABLES="'U',     'KIND_U_WIND_COMPONENT',     'TYPE_U',  'UPDATE','999',
                           ...
                           'E_O3',  'KIND_O3',                   'TYPE_E_O3', 'UPDATE','999',
...
export NL_CONC_STATE_VARIABLES="'U',     'KIND_U_WIND_COMPONENT',     'TYPE_U',  'UPDATE','999',
                           ...
                           'pan',   'KIND_PAN',                  'TYPE_PAN', 'UPDATE','999',
                           'ald',   'KIND_ALD',                  'TYPE_ALD', 'UPDATE','999'"
export NL_EMISS_STATE_VARIABLES="'E_O3', 'KIND_O3',              'TYPE_E_O3', 'UPDATE','999',
                           'E_CO',  'KIND_CO',                   'TYPE_E_CO', 'UPDATE','999',
                           'E_NO',  'KIND_NO',                   'TYPE_E_NO', 'UPDATE','999'"
...
#####
#
# APM: need to copy and disburse updated emissions
#
####
