...
#
# CYCLE DATE-TIME:
export CYCLE_STR_DATE=2014070306
export CYCLE_END_DATE=2014070306
...
export INITIAL_DATE=2014070300
export FIRST_FILTER_DATE=2014070306
...
#
export RUN_DIR=/glade/scratch/mizzi/real_OMI_v3.6.1_6h
...
export OMICOMB_DATA_DIR=${OMI_DATA_DIR}/obs_OMICOMB_filt
#
...
0.1231982,0.08322784,0.06684654,0.04016809,0.0294686,\
0.02028209,0.000
#
# PHYSICS NAMELIST:
...
#
   ...
   ln -fs ${GEOGRID_DIR}/geo_em.d${CR_DOMAIN}.int ./.
...
if [[ ${RUN_OMI_INPUT} = "true" ]]; then 
   ...
   export OMI_INPUT_DIR=${OMI_DATA_DIR}/met_em
   export P_DATE=${DATE}
   ...
   while [[ ${P_DATE} -le ${P_END_DATE} ]] ; do
      ...
      cp ${OMI_INPUT_DIR}/${P_DATE}/met_em.d* ${METGRID_DIR}/.
...
#      cp ${OMICOMB_DATA_DIR}/${DATE}/obs_seq_perf_* ${RUN_DIR}/${DATE}/preprocess_obs/.
      cp ${OMICOMB_DATA_DIR}/${DATE}/obs_seq_comb_* ${RUN_DIR}/${DATE}/omi_no2_obs/.
      cp ${OMICOMB_DATA_DIR}/${DATE}/obs_seq_comb_* ${RUN_DIR}/${DATE}/preprocess_obs/.
   fi
fi
#
#########################################################################
