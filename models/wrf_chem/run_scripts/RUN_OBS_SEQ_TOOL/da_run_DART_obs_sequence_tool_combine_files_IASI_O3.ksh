...
# GET OBS FILES TO BE COMBINED
     rm -rf ./obs_seq_MET
     rm -rf ./obs_seq_MOPITT_CO
     rm -rf ./obs_seq_IASI_CO
     rm -rf ./obs_seq_IASI_O3
     rm -rf ./obs_seq_MOPnIAS_CO
     export MET_FLG=0
     ...
     if [[ -e ${RET_IASI_O3_OBS_DIR}/obs_seq_${L_DATE}.out ]]; then
        export IAS_FLG=1
        cp ${RET_IASI_O3_OBS_DIR}/obs_seq_${L_DATE}.out ./obs_seq_IASI_O3
     fi
#     cp ${RET_MOPITT_CO_OBS_DIR}/obs_seq_mopitt_${DT_DATE} ./obs_seq_MOPITT_CO
#     cp ${RET_IASI_CO_OBS_DIR}/obs_seq_iasi_${DT_DATE} ./obs_seq_IASI_CO
#     cp ${RET_MOPnIAS_CO_OBS_DIR}/${L_DATE}/obs_seq_comb_${L_DATE}.out ./obs_seq_MOPnIAS_CO
#
...
# min wrf
     if [[ ${MET_FLG} -eq 1 && ${IAS_FLG} -eq 0 ]]; then
        ...
        export NL_FILENAME_SEQ="'obs_seq_MET','obs_seq_IASI_O3'"
     fi    
     ...
     export NL_SYNONYMOUS_COPY_LIST="'NCEP BUFR observation','IASI O3 observation'"
     export NL_SYNONYMOUS_QC_LIST="'NCEP QC index','IASI O3 QC index'"
     export NL_MIN_LAT=7.
