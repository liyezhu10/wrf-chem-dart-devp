...
#
# $Id: advance_model_old.ksh 13133 2019-04-25 21:47:54Z nancy@ucar.edu $
#
...
#
   if [[ ! -d ${CENTRALDIR}/WRFCHEM_RUN ]]; then
      echo ERROR: ${CENTRALDIR}/WRFCHEM_RUN does not exist
      exit
   fi
# Link in WRFCHEM/MEMBER - runtime files
   cp ${CENTRALDIR}/WRFCHEM_RUN/* ./.
#
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/tags/wrf-chem.r13172/models/wrf_chem/shell_scripts/advance_model_old.ksh $
# $Id: advance_model_old.ksh 13133 2019-04-25 21:47:54Z nancy@ucar.edu $
# $Revision: 13133 $
