...
#export DIR_NAME=real_FRAPPE_AIRNOW_CONTROL
export DIR_NAME=real_FRAPPE_RETR_AIR_CO
#export DIR_NAME=real_FRAPPE_RETR_AIR_O3
#export DIR_NAME=real_FRAPPE_RETR_AIR_NO2
#export DIR_NAME=real_FRAPPE_RETR_AIR_SO2
#
# Define FILTER path
...
#
rm -rf input.nml
${DART_DIR}/models/wrf_chem/namelist_scripts/DART/dart_create_input_mlevel.nml.ksh
#
###############################################################################
#
# RUN OBS_DIAG
