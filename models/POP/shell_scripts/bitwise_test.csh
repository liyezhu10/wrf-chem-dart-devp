...
set testcase    = "/glade/p/image/DART_test_cases/pop/pop_gx1v6"

# for POP
set model_to_dart = "pop_to_dart"
set dart_to_model = "dart_to_pop"
set model_restart = "pop.r.nc"
set dart_restart  = "dart_restart"

set trunk_restarts = "filter_restart"
set obsfile        = "obs_seq.final"
set out_stub       = "pop_out.r"
...
cp $rundir/$basecase/test_rma/pop.r0001.nc $rundir/$basecase/test_rma/pop_out.r.0001.nc
cp $rundir/$basecase/test_rma/pop.r0002.nc $rundir/$basecase/test_rma/pop_out.r.0002.nc
cp $rundir/$basecase/test_rma/pop.r0003.nc $rundir/$basecase/test_rma/pop_out.r.0003.nc
