...
integer           :: distlocnum       = 200    ! locnum for distance between obs and var
...
!       thus put the writting out of OMP loop
      do inddim = ind, ind    !indvar_s, indvar_e
         writelenloc = locnum
         write(idchar, '(i1.1)') id
         ...
         do obslevk = 1, obslev_num
            do varlevk = 1, varlev_num
               ...
               numtmp(1:writelenloc) = localization%num(1:writelenloc,1,inddim)
               write(iunit, FMT=locreal_format) numtmp 
               write(iunit, FMT=locreal_format) localization%sumx(1:writelenloc,1,inddim)
               write(iunit, FMT=locreal_format) localization%sumy(1:writelenloc,1,inddim)
               write(iunit, FMT=locreal_format) localization%sumx2(1:writelenloc,1,inddim)
               write(iunit, FMT=locreal_format) localization%sumy2(1:writelenloc,1,inddim)
               write(iunit, FMT=locreal_format) localization%numerator(1:writelenloc,1,inddim)
               write(iunit, FMT=locreal_format) localization%denominator(1:writelenloc,1,inddim)
!               write(iunit, FMT=locreal_format) localization%alpha1(1:writelenloc,1,inddim)
!               write(iunit, FMT=locreal_format) localization%alpha2(1:writelenloc,1,inddim)
               write(iunit, FMT=locreal_format) localization%abscorr(1:writelenloc,1,inddim)
               write(iunit, FMT=locreal_format) localization%correlation(1:writelenloc,1,inddim)
               deallocate(numtmp)
