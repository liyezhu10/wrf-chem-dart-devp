...
real(r8)         :: varlat, varlon, dist, hgtrad1, hgtrad2
...
!$OMP PARALLEL DO PRIVATE(ind,i,j,k,ii,jj,kk,inddim,ndims,indk1,indk2,iunit,writelenloc,var_name_tmp,obslon,obslat,varlon,varlat,obsi,obsj,obsk,obspres,obshgt,is_lev0,yobs,ytrue,yfmean,Robs,yvar,yprior_var,ypost_var,corr,reg_coef,ccc,ddd,dist,disthgt,yinno_norm,xtrue,xfmean,xt_xfmean,covxy,deltaxmean,ilocind,sublocnum,sublocnomi,sublocalpha,sublocdenomi,wrf_var_1d,xprior,yprior,xtrueprf,xfmeanprf,xfspdprf,xpriorprf,xtrue3d,xfmean3d,xfspd3d,xprior3d)

! Lili test
      LoopVarTypes: do inddim = 1, wrf%dom(id)%number_of_wrf_variables 
...
!pause
                     ...
                     ! get the terrian into account
                     disthgt = abs(wrf%dom(id)%hgt(i,j) - wrf%dom(id)%hgt(ii,jj))
! Lili test
