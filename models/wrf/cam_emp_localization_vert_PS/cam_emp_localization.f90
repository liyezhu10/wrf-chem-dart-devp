...
!pause
                     ...
                     ! record in distance
                     localization%num(ilocind,k,inddim) = localization%num(ilocind,k,inddim) + 1

                     localization%sumx(ilocind,k,inddim) = localization%sumx(ilocind,k,inddim) + sublocx
                     localization%sumy(ilocind,k,inddim) = localization%sumy(ilocind,k,inddim) + sublocy

                     localization%sumx2(ilocind,k,inddim) = localization%sumx2(ilocind,k,inddim) + sublocx2
                     localization%sumy2(ilocind,k,inddim) = localization%sumy2(ilocind,k,inddim) + sublocy2

                     localization%numerator(ilocind,k,inddim) = localization%numerator(ilocind,k,inddim)     &
                                                                + sublocnumer
                     localization%denominator(ilocind,k,inddim) = localization%denominator(ilocind,k,inddim) &
                                                                  + sublocdenom
                     ...
                     localization%correlation(ilocind,k,inddim) = localization%correlation(ilocind,k,inddim) + abs(corr)
                     endif
...
!print *, 'idchar = ', idchar
         var_name_tmp = trim(obs%obstype_metadata(idobs))//'_'//         &
                        trim(cam%description(inddim))//'_obslev'//idchar
...
!pause
         ...
         numtmp(1:writelenloc) = localization%num(1:writelenloc,k,inddim)
         write(iunit, FMT=locreal_format) numtmp 
         write(iunit, FMT=locreal_format) localization%sumx(1:writelenloc,k,inddim)
         write(iunit, FMT=locreal_format) localization%sumy(1:writelenloc,k,inddim)
         write(iunit, FMT=locreal_format) localization%sumx2(1:writelenloc,k,inddim)
         write(iunit, FMT=locreal_format) localization%sumy2(1:writelenloc,k,inddim)
         write(iunit, FMT=locreal_format) localization%numerator(1:writelenloc,k,inddim)
         write(iunit, FMT=locreal_format) localization%denominator(1:writelenloc,k,inddim)
         write(iunit, FMT=locreal_format) localization%alpha1(1:writelenloc,k,inddim)
         write(iunit, FMT=locreal_format) localization%alpha2(1:writelenloc,k,inddim)
         write(iunit, FMT=locreal_format) localization%correlation(1:writelenloc,k,inddim)
         deallocate(numtmp)
