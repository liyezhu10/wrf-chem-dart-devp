...
WRFDomains : do id = dom_start, wrf_ndom 
...
! Lili test
         do j = nbdy_nouse+1, wrf%dom(id)%sn-nbdy_nouse, 3 
!         do j = 50, 50
            do i = nbdy_nouse+1, wrf%dom(id)%we-nbdy_nouse, 3
!            do i = 50, 50
               if ( obs%dom(id)%obs_val(i,j,1,1,idobs) /= missing_r8 ) then
...
! Lili test
!print *, 'obs diag ', yprior(1:ens_size:5)
!pause
...
! Lili test
!print *, 'obs loc diag ', obslon, obslat
!pause
                  do kk = mlevk1, mlevk2 
                  do jj = nbdy_nouse+1, wrf%dom(id)%sn-nbdy_nouse, 3
!                  do jj = 50, 50
! Lili test
!print *, 'jj = ', jj
                  do ii = nbdy_nouse+1, wrf%dom(id)%we-nbdy_nouse, 3
! Lili test
!print *, 'ii = ', ii
...
! Lili test
!print *, 'var loc diag ', varlon, varlat
!pause
...
! Lili test
!print *, 'stat diag ', xtrue3d(ii,jj,kk), xfmean3d(ii,jj,kk)
!print *, 'stat diag ', xprior3d(ii,jj,kk,1), xprior3d(ii,jj,kk,ens_size)
!print *, 'stat diag ', covxy, yprior_var, reg_coef
!print *, 'stat diag ', ccc, ddd
