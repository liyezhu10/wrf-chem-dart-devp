...
public :: clm_get_model_size,         &
          clm_adv_1step,              &
          clm_get_state_meta_data,    &
          clm_model_interpolate,      &
          clm_get_model_time_step,    &
          clm_static_init_model,      &
          clm_end_model,              &
          clm_init_time,              &
          clm_init_conditions,        &
...
function clm_get_model_size()
!------------------------------------------------------------------
! Returns the size of the model as an integer.
! Required for all applications.

integer :: clm_get_model_size

if ( .not. module_initialized ) call clm_static_init_model

clm_get_model_size = model_size

end function clm_get_model_size



subroutine clm_adv_1step(x, time)
!------------------------------------------------------------------
...
end subroutine clm_adv_1step



subroutine clm_get_state_meta_data(indx, location, var_type)
!------------------------------------------------------------------
...
return
end subroutine clm_get_state_meta_data



function clm_get_model_time_step()
!------------------------------------------------------------------
!
...
type(time_type) :: clm_get_model_time_step

if ( .not. module_initialized ) call clm_static_init_model

clm_get_model_time_step = model_timestep

end function clm_get_model_time_step
...
call find_namelist_in_file('input.nml', 'clm_model_nml', iunit)
read(iunit, nml = clm_model_nml, iostat = io)
call check_namelist_read(iunit, io, 'clm_model_nml')
...
end subroutine clm_static_init_model



subroutine clm_end_model()
!------------------------------------------------------------------
!
...
end subroutine clm_end_model



subroutine clm_init_time(time)
!------------------------------------------------------------------
!
...
end subroutine clm_init_time



subroutine clm_init_conditions(x)
!------------------------------------------------------------------
!
...
end subroutine clm_init_conditions



function clm_nc_write_model_atts( ncFileID ) result (ierr)
!------------------------------------------------------------------
...
end function clm_nc_write_model_atts



function clm_nc_write_model_vars( ncFileID, state_vec, copyindex, timeindex ) result (ierr)
!------------------------------------------------------------------
...
end function clm_nc_write_model_vars



subroutine clm_pert_model_state(state, pert_state, interf_provided)
!------------------------------------------------------------------
!
...
end subroutine clm_pert_model_state



subroutine clm_ens_mean_for_model(filter_ens_mean)
!------------------------------------------------------------------
...
end subroutine clm_ens_mean_for_model
...
subroutine clm_sv_to_restart_file(state_vector, filename, dart_time)
!------------------------------------------------------------------
...
end subroutine clm_sv_to_restart_file
...
subroutine clm_model_interpolate(x, location, obs_kind, interp_val, istatus)
...
end subroutine clm_model_interpolate
