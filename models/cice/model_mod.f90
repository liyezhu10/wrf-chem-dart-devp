...
! locations & kinds (locs, loc_qtys/types), returns the subset close to the
...
call loc_get_close_obs(filt_gc, base_loc, base_type, locs, loc_qtys, loc_types, &
