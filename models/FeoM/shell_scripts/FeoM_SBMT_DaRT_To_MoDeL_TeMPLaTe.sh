#!/bin/bash
#BSUB -J ENSDART2M[1-MEMBER]         # Name of the job.
#BSUB -o LOG/TSSEXPCODEEXPNO_D2M_%J_%I.out  # Appends std output to file %J.out.
#BSUB -e LOG/TSSEXPCODEEXPNO_D2M_%J_%I.out  # Appends std error to file %J.err.
